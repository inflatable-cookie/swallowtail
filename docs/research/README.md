...
- [292 OpenCode HTTP 1.18.29 Identity](./292-opencode-http-1-18-29-identity.md) — promoted through g05.037 card 134; npm/GitHub identity and deterministic artifact delta frozen for `1.18.28` → `1.18.29`; compatible `surface-19` extension admitted; production claims unchanged; card 135 remains serial
