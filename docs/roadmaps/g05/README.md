...
| Prove one skill-discovery route and one watcher-enforcement route without flattening provider behavior. | Qoder and first Claude live proofs stopped; Linux/per-platform repair and one still-unconsumed exact retry ready; live claim withheld | Contracts 058-060; Research 256-261; card 011 live stop; g05.006 card 019; g05.007 card 020 | `g05.002`, `g05.003`, `g05.006`, and `g05.007` |
...
- [g05.007 Claude Watcher Live Acceptance](007-claude-watcher-live-acceptance.md) — ready; card 020; Linux/per-platform repair, then one exact `2.1.251` Haiku turn; no fallback or rerun
...
currentness at 004 and 005, honest evidence stops at 002 and 003, and one ready
milestone at 007.
...
could not satisfy the Darwin-only digest envelope; PR 127 remains unmerged and
the turn is unconsumed. The operator selected Linux on 2026-08-31. The new
worker may repair only per-platform digest selection, prove it without provider
contact, commit the repair, and then validate exact official `linux-x64` digest
`fd5f10ff0eb58daec04900466b143ea98aab50abf208a422bc008eaec13f61f7`
before the sole turn. Only a complete ordered live oracle may publish the exact
watcher point.
...
- [007 Claude Watcher Live Acceptance](./007-claude-watcher-live-acceptance.md) — ready; card 020; Linux/per-platform repair plus one exact live turn authorized; claims still withheld
