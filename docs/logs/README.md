...
- [2026-09-03 g05.021 Card 051 Lock Sync Prerequisite](./2026-09-03-g05-021-card-051-lock-sync-prerequisite.md) — first authorized prepare exposed stale workspace lock; the second exposed parallel watcher-fixture path reuse at the floor; accepted Effigy owns package-aware lock sync and unique fixture roots remove the test alias before the final one-shot prepare freezes the candidate
