use super::DeepAgentsPreparedIntegration;
...
/// Working resource for one bounded Deep Agents ACP session.
pub struct DeepAgentsSessionProfileInput {
    request_id: RequestId,
    working_resource: WorkingResourceRef,
}

impl DeepAgentsSessionProfileInput {
    #[must_use]
...
#[derive(Clone, Debug, Eq, PartialEq)]
/// Prepared Deep Agents ACP session ready for initialize plus one bounded prompt.
pub struct DeepAgentsPreparedSession {
...
impl DeepAgentsPreparedIntegration {
    ...
    pub fn prepare_session(
        ...
        let descriptor = crate::deepagents_acp_descriptor();
...
impl DeepAgentsPreparedSession {
    #[must_use]
    ...
    pub fn open_session(
        ...
        let driver = crate::DeepAgentsAcpDriver::new(self.environment.clone());
    ...
    pub fn prepare_working_state_restoration(
        ...
        PreparedWorkingStateRestoration::fresh_session_replacement(
            interrupted_turn_id,
            crate::DeepAgentsAcpDriver::new(self.environment.clone()),
            self.plan().clone(),
            self.request.clone(),
        )
    }
...
fn access_requirement(integration: &DeepAgentsPreparedIntegration) -> AccessRequirement {
