...
- [2026-09-24 Grok Build ACP 1.0.41 Identity](./2026-09-24-grok-build-acp-1-0-41-identity.md) — Research 340 froze the `1.0.41` hop after the `1.0.40` ceiling with reproduced `1.0.40` baseline identity, a byte-identical selected-literal presence map, an unchanged `grok-4.6` model document, the 62 mapped-core ACP modules, one added unmapped `subagent_handoff` module, and the unchanged shipped-file inventory; compatible extension at the current official stable, with the exact `1.0.30` catalogue claim and the `1.0.4`/`1.0.5` registered-tool courier independently bounded
...
- [2026-09-21 Grok Build ACP 1.0.40 Claim](./2026-09-21-grok-build-acp-1-0-40-claim.md) — raised `grok-build.executable` through official `1.0.40`; qualified all ten published stable hops, kept the baseline, deprecated `0.2.114..=0.2.117`, gaps, `grok-4.6` binding, and `AllowUnverified`, and left the exact `1.0.30` catalogue claim and the `1.0.4`/`1.0.5` registered-tool courier independent of the ACP window; superseded on 2026-09-24 when `1.0.41` published
- [2026-09-21 Grok Build ACP 1.0.40 Identity](./2026-09-21-grok-build-acp-1-0-40-identity.md) — Research 340 first froze all ten published stables `1.0.31..=1.0.40` after qualified `1.0.30` with linux-x64 compared-platform identity, a darwin-arm64 cross-check that reproduces Research 314, a byte-identical selected-literal presence map, an unchanged `grok-4.6` model document, the 62 mapped-core ACP modules, and a complete shipped-file inventory; the 2026-09-24 record extends the same corpus through `1.0.41`, with the exact `1.0.30` catalogue claim and the `1.0.4`/`1.0.5` registered-tool courier independently bounded
...
- [2026-09-21 Claude Code 2.1.278 Identity](./2026-09-21-claude-code-2-1-278-identity.md) — Research 331 froze all eight published hops from qualified `2.1.270` to official `2.1.278` and classified both existing stream-JSON axes as a compatible extension from embedded-source mapped-surface evidence; host `claude` not installed; production claims unchanged
- [2026-09-21 Codex 0.155.1 Claim](./2026-09-21-codex-0-155-1-claim.md) — raised `codex.cli` exec and app-server through official `0.155.1`; qualified both published hops, pinned newly interior `0.154.1` incompatible, synthetic `0.155.2` `UnverifiedNewer`, and every feature-specific exact set unchanged
- [2026-09-21 Codex 0.155.1 Identity](./2026-09-21-codex-0-155-1-identity.md) — Research 333 froze both published hops from qualified `0.154.0` to official `0.155.1` with complete wrapper/platform/source-tree inventories; exec tree byte-identical; selected schema params byte-identical or additive-only with bounded unmapped deltas; compatible extension named; production claims unchanged
...
- [2026-09-21 Qwen Code 0.24.2 Identity](./2026-09-21-qwen-code-0-24-2-identity.md) — Research 334 froze complete npm package inventories and direct family release/tag identities after `0.23.3`; selected surfaces remained compatible and all changed adjacent internals stayed unmapped
- [2026-09-21 Claude Agent ACP 0.79.0 Claim](./2026-09-21-claude-agent-acp-0-79-0-claim.md) — raised `claude-agent.acp-adapter` through official `0.79.0` (`0.66.0..=0.79.0`); qualified the three published hops `0.77.0`/`0.78.0`/`0.79.0`, kept `0.58.0`/`0.73.1`/`0.74.1`/`0.75.2`/`0.76.1`/`0.77.1`/`0.78.1` incompatible, synthetic `0.80.0` `UnverifiedNewer`, and `AllowUnverified`; already-mapped elicitation accepts the two new Other descriptions; removed `agent` config, capability-gated `compaction_update`, Agent SDK pin, and shell permission titles stay unmapped
- [2026-09-21 Claude Agent ACP 0.79.0 Identity](./2026-09-21-claude-agent-acp-0-79-0-identity.md) — Research 335 froze all three published hops from qualified `0.76.0` to official `0.79.0`, proved `0.73.1`/`0.74.1`/`0.75.2`/`0.76.1`/`0.77.1`/`0.78.1`/`0.80.0` unpublished, and classified the family as a compatible extension of initialize-meta-extensions-v7 from a complete dist inventory; ACP SDK pin stays `1.4.0`; Agent SDK pin and capability-gated compaction stay unmapped
- [2026-09-21 Oh My Pi 18.2.7 Claim](./2026-09-21-oh-my-pi-18-2-7-claim.md) — raised the existing `18.x` segment from `18.0.0..=18.1.22` to `18.0.0..=18.2.7` on unchanged `oh-my-pi.rpc-v2-v18.0.0`; published `18.2.0` through `18.2.6` are qualified; `18.2.8` stays permitted `UnverifiedNewer`; claim id, 17.x segment, exclusions, and decoder corpus stay
- [2026-09-21 Oh My Pi 18.2.7 Identity](./2026-09-21-oh-my-pi-18-2-7-identity.md) — Research 345 froze official npm/GitHub `18.2.7` and the eight published hops after `18.1.22`; selected JSONL wire is byte-identical; remaining mapped hops are unmapped; decision is compatible-extension, not a major-line reset
- [2026-09-21 Pi RPC 0.86.1 Claim](./2026-09-21-pi-rpc-0-86-1-claim.md) — qualified `pi.package` through official `0.86.1`; preserved baseline, gaps including unpublished `0.85.2`, message-update-delta, and `AllowUnverified`
- [2026-09-21 Pi RPC 0.86.1 Identity](./2026-09-21-pi-rpc-0-86-1-identity.md) — Research 344 froze official npm/GitHub `0.86.1` as a compatible message-update-delta extension via published `0.86.0`; production claims unchanged
...
- [2026-09-21 Antigravity 1.2.7 Catalogue Identity](./2026-09-21-antigravity-1-2-7-identity.md) — Research 346 froze official GitHub `1.2.3` through `1.2.7` as a catalogue-only compatible extension; the `1.1.22` headless stop stands and the gap becomes `1.1.18..=1.2.7`
- [2026-09-21 Ollama 0.34.2 Claim](./2026-09-21-ollama-0-34-2-claim.md) — raised `ollama.runtime` through official `0.34.2` as a compatible extension after decoder-tolerance of `prompt_eval_cached_count`; qualified hops `0.33.3` through `0.34.2`; exclusions, behavior, specimen, and `AllowUnverified` kept; synthetic `0.34.3` stays `UnverifiedNewer`
- [2026-09-21 Ollama 0.34.2 Identity](./2026-09-21-ollama-0-34-2-identity.md) — Research 342 froze all four published hops from qualified `0.33.2` to official `0.34.2` with tag/commit/tree/tarball and selected-file hashes; seven selected structs byte-identical through `0.34.2`; compatible extension named after decoder-tolerance of `prompt_eval_cached_count`; production claims unchanged
...
- [2026-09-17 Goose ACP 1.50.1 Identity](./2026-09-17-goose-acp-1-50-1-identity.md) — Research 328 re-probed the official release, froze tag and Darwin ARM64 archive identity, and classified the selected ACP patch hop as byte-identical except for an unmapped MCP protocol-version default
- [2026-09-15 Oh My Pi 18.1.22 Claim](./2026-09-15-oh-my-pi-18-1-22-claim.md) — extended the retained `17.x` segment to `17.2.9..=17.4.2` on the unchanged `oh-my-pi.rpc-v2-v17.2.9` revision and admitted a distinct adapter-private `18.x` segment `18.0.0..=18.1.22` on the new `oh-my-pi.rpc-v2-v18.0.0` revision; the claim id moves to `oh-my-pi.rpc.package-window-2` per Contract 029, the retained `17.x` segment becomes `Deprecated`, `18.0.2` and `18.1.7` are explicit exclusions, `17.4.3`/`17.4.4` stay incompatible between segments, and `18.1.23` stays permitted `UnverifiedNewer`
- [2026-09-15 Oh My Pi 18.1.22 Identity](./2026-09-15-oh-my-pi-18-1-22-identity.md) — Research 327 froze the complete published ledger from `17.4.0` through official `18.1.22` with reproduced integrity, shasum, tarball, `dist/cli.js`, file-count, and tag-commit identity plus one deterministic per-hop shipped-tree inventory; every mapped RPC hop through `18.1.22` is byte-identical or unmapped/additive/resolved, Research 217 reproduces with the `17.4.2` landing correction, and the four npm-unpublished tags stay explicit and incompatible
- [2026-09-15 Kimi Code Local Server 0.43.0 Claim](./2026-09-15-kimi-code-local-server-0-43-0-claim.md) — extended the local-server claim to maintained `0.35.0..=0.39.1` on the unchanged heartbeat-ping revision, changed the posture to `QualifiedOnly`, and revised the claim id to `kimi.local-server.executable-window-5` per Contract 029, so the uncontained `0.40.0` Bash `cwd` widening and every later point through `0.43.0` fail closed; ACP and headless untouched
- [2026-09-15 Kimi Code Local Server 0.43.0 Identity](./2026-09-15-kimi-code-local-server-0-43-0-identity.md) — Research 326 froze the local-server selected-file ledger spanning `0.38.0..=0.43.0` with reproduced npm/GitHub identity at every point; `0.39.0..=0.39.1` preserve the Bash workspace assertion while the `0.40.0` removal persists byte-identical through `0.43.0`, and the two newly classified hops add no containment
- [2026-09-15 Kimi Code 0.43.0 Installed Claim](./2026-09-15-kimi-code-0-43-0-claim.md) — extended `kimi.headless.executable-window-2` to maintained `0.33.0..=0.43.0` on the unchanged `kimi.headless.stream-json.v2` revision with the selected argv, JSONL grammar, retry record, terminal shape, retention, cancellation, and cleanup unchanged; `kimi-code.acp` stays `QualifiedOnly` at `0.38.0` because the g05.017 A2 `terminal: false` local host-process spawn is byte-identical through `0.43.0`, with `0.40.0..=0.43.0` a posture-rejected gap and no new exclusion
- [2026-09-15 Kimi Code 0.43.0 Installed Identity](./2026-09-15-kimi-code-0-43-0-identity.md) — Research 325 froze official npm/GitHub identity for `0.39.1`, `0.40.0`, `0.40.1`, `0.41.0`, `0.42.0`, and `0.43.0` with tarball, tag, tree, source-archive, and release-asset digests, one deterministic tagged-source inventory per point, a mutation-sensitive selected-file blob ledger, and a bundle oracle that reproduces the frozen A2 `AcpProcessService` digest at all six points
- [2026-09-15 Gemini CLI 0.59.0 Claim](./2026-09-15-gemini-cli-0-59-0-claim.md) — raised both separate Gemini CLI ceilings to maintained `0.51.0..=0.59.0` with the ACP and headless claim ids, baselines, behavior revisions, and `AllowUnverified` unchanged; every ACP source and every selected stream-json, terminal, option, and retention source is byte-identical, workspace trust, policy checkers, sandbox, and ambient MCP stay unmapped, and unpublished `0.59.1` stays visible `UnverifiedNewer`
- [2026-09-15 Gemini CLI 0.59.0 Identity](./2026-09-15-gemini-cli-0-59-0-identity.md) — Research 324 froze official npm/GitHub identity for `0.56.0`, `0.57.0`, `0.58.0`, and `0.59.0` with tarball, tag, tree, source-archive, and darwin-arm64 digests plus one deterministic tagged-source inventory per point; both axes are compatible extensions because every ACP source and every selected stream-json, terminal, option, and retention source is byte-identical, with only `geminiChat.ts` provider-request internals and the worktree git helper changing
- [2026-09-15 Antigravity 1.2.2 Claim](./2026-09-15-antigravity-1-2-2-claim.md) — g05.075 split the Antigravity claims per Tom's release-notes authority ruling: the catalogue claim advanced to maintained `1.1.9..=1.2.2` with no published selected-path change, while headless keeps the `1.1.17` ceiling at the exact `1.1.22` provider-managed-retry stop with `1.1.18..=1.2.2` as the named unqualified gap
- [2026-09-15 Antigravity 1.2.2 Identity](./2026-09-15-antigravity-1-2-2-identity.md) — Research 323 froze official GitHub identity for `1.1.27` through `1.2.2` with both platform digests and the reproduced `1.1.26` boundary, classified the published selected-path changes per claim under Tom's release-notes authority ruling, and preserved the pre-ruling collected hashes with exhaustive binary scanning stopped
- [2026-09-14 Deep Agents ACP 0.1.30 Claim](./2026-09-14-deepagents-acp-0-1-30-claim.md) — g05.074 advanced the exact `QualifiedOnly` Deep Agents ACP point to `0.1.30` with the unchanged `deepagents.acp.stdio-v1` behavior, empty selected argv, and route boundaries; the sole CLI body change is unreachable on the selected route, the `deepagents` dependency chain is classified decoder-invisible, and the stale registry entry and constructor-default `agentInfo.version` stay outside the claim
- [2026-09-14 Deep Agents ACP 0.1.30 Identity](./2026-09-14-deepagents-acp-0-1-30-identity.md) — Research 322 froze official npm `0.1.25` plus all five published stable successors through `0.1.30` and the exact-pinned `deepagents` `1.12.4..=1.13.4` runtime dependency chain as digest-verified tarballs; the selected no-extra-argv stdio wire is byte-stable with the sole CLI body change dead on the selected route, and additive `delete`-tool and read-pagination deltas are classified decoder-invisible; the stale ACP registry `0.1.7` entry and constructor-default `agentInfo.version` `0.0.1` stay outside the claim
- [2026-09-14 Mistral Vibe 2.25.4 Claim](./2026-09-14-mistral-vibe-2-25-4-claim.md) — g05.073 advanced the exact `QualifiedOnly` Mistral Vibe headless point to `2.25.4` with the unchanged `mistral-vibe.headless.stdio-streaming-v1` behavior and one adapter-private `--legacy-harness` argv pin against the `2.25.1` ambient harness-rollout machinery; the Unified Harness and `--smart-approve` stay unmapped and GitHub-only `2.24.4` remains a named PyPI packaging gap
- [2026-09-14 Mistral Vibe 2.25.4 Identity](./2026-09-14-mistral-vibe-2-25-4-identity.md) — Research 321 froze official `2.24.2` plus all eight published stable successors through `2.25.4` as exact source tarballs and registry-matched distributions; the streaming wire, limit middleware, Plan profile, and lifecycle are byte-stable, `2.24.4` stays a named PyPI packaging gap, and the `2.25.1` harness-rollout machinery is pinned by adapter-private `--legacy-harness` while the Unified Harness stays unmapped
- [2026-09-14 Kiro ACP 2.21.4 Claim](./2026-09-14-kiro-acp-2-21-4-claim.md) — g05.072 advanced the exact `QualifiedOnly` Kiro ACP point to `2.21.4` with the unchanged `kiro.acp.stdio-v1` behavior and route boundaries; every selected surface input is byte-stable across all eleven hops and the `_kiro.dev`/`session/load` additions stay unmapped
- [2026-09-14 Kiro ACP 2.21.4 Identity](./2026-09-14-kiro-acp-2-21-4-identity.md) — Research 320 froze official `2.18.1` plus all eleven published stable successors through `2.21.4` as exact archives; every selected wire, lifecycle, permission, authentication, and cleanup input is byte-stable, `_kiro.dev` extensions and `session/load` stay unmapped additions, and Research 251/254's empty deliver-now sets stand
- [2026-09-14 Goose ACP 1.50.0 Identity Stop](./2026-09-14-goose-acp-1-50-0-identity-stop.md) — Research 319 froze official `1.46.0` plus all four published stable successors through `1.50.0`; provider-auth failure becomes typed `auth_required` on `session/new` and `session/prompt` at the exact hop `1.46.0..1.47.0`, so no `1.50.0` claim lands, the `QualifiedOnly` point stays at `1.46.0`, and the failure-binding policy returns to the operator
- [2026-09-14 Qoder Headless 1.1.52 Identity Stop](./2026-09-14-qoder-headless-1-1-52-identity-stop.md) — Research 318 froze official `1.1.25` plus all 27 published stable successors through `1.1.52`; the selected route's own `--max-turns 8` argv stops being inert history at the exact hop `1.1.29..1.1.30` and becomes the AgentLoop ceiling, so no `1.1.52` claim lands, the `QualifiedOnly` point stays at `1.1.25`, and the turn-binding policy returns to the operator
- [2026-09-14 Command Code 1.54.0 Claim](./2026-09-14-command-code-1-54-0-claim.md) — g05.068 advanced the exact `QualifiedOnly` Command Code point to `1.54.0` with the unchanged AgentEvent behavior and route boundaries; Research 116/118 live evidence remains bound to `1.15.1`, so live-derived cells await separate exact-`1.54.0` requalification
- [2026-09-14 Command Code 1.54.0 Identity](./2026-09-14-command-code-1-54-0-identity.md) — Research 317 froze all 67 published stable successors after `1.15.1`; the complete package inventory has no removals, eight additive bundled references, and a byte-identical entrypoint; selected invocation, AgentEvent, result, usage, failure, and local lifecycle surfaces remain compatible; old live evidence stays version-bound
- [2026-09-14 Grok Build Catalogue 1.0.30 Claim](./2026-09-14-grok-build-catalogue-1-0-30-claim.md) — g05.067 advanced the exact `QualifiedOnly` catalogue point to `grok-build.catalogue.executable-1-0-30` with the `grok-build.catalogue.models-text-v1` behavior revision unchanged; the provider-free gates passed first and one prompt-free authenticated `--no-auto-update models` observation returned ordered `grok-4.6` default then `grok-4.5` with zero stderr and no prompt, session, inference, or tool; the Grok ACP window, registered-tool courier, and historical `1.0.25` evidence stay independent
- [2026-09-14 Grok Build Catalogue 1.0.30 Identity](./2026-09-14-grok-build-catalogue-1-0-30-identity.md) — Research 316 reproduced the Research 314 platform tarball, brotli, and executable digests for the previous exact `1.0.25` catalogue point and every later stable through official `1.0.30`, and proved the catalogue argv grammar, authentication preamble, shipped bullet literals, module path, and embedded default-model document identical at every hop; compatible extension of the exact `QualifiedOnly` catalogue point with the behavior revision unchanged; production claims unchanged
- [2026-09-14 Claude Agent SDK 0.3.270 Claim](./2026-09-14-claude-agent-sdk-0-3-270-claim.md) — g05.065 rebound the exact one-point package/native tuple to SDK `0.3.270` / native `2.1.270` with behavior, wire, Node, sidecar-tag axes, claim ids, and QualifiedOnly posture unchanged; Research 301 stays bound to `0.3.259`/`2.1.259`, so the compiled tuple projects `registered_tools` and `consumer_tool_exchange` unqualified until a separately authorized live requalification runs
- [2026-09-14 Claude Agent SDK 0.3.270 Identity](./2026-09-14-claude-agent-sdk-0-3-270-identity.md) — Research 315 froze all nine published hops `0.3.260..=0.3.270` after qualified `0.3.259` with wrapper/native coupling, tarball digests, native commits, platform payloads, and a complete 15-file inventory; 42 declaration surfaces classified unmapped with the mapped subset, lifecycle, and credential posture unchanged; production claims unchanged
- [2026-09-14 Grok Build ACP 1.0.30 Claim](./2026-09-14-grok-build-acp-1-0-30-claim.md) — g05.064 raised `grok-build.executable` through official `1.0.30`; qualified all 25 published stable hops, kept the baseline, deprecated `0.2.114..=0.2.117`, gaps, `grok-4.6` binding, and `AllowUnverified`, left alpha `1.0.31` and unpublished `1.0.32` `UnverifiedNewer`, and decoupled the exact `1.0.25` catalogue claim and the `1.0.4`/`1.0.5` registered-tool courier from the ACP window
- [2026-09-14 Grok Build ACP 1.0.30 Identity](./2026-09-14-grok-build-acp-1-0-30-identity.md) — Research 314 froze all 25 published stables `1.0.6..=1.0.30` after qualified `1.0.5` with wrapper/platform integrities, tarball and executable digests, and a complete shipped-file inventory; the mapped ACP literal presence map is byte-identical at every hop, the embedded model document changes once for the unread `show_model_fingerprint` key, and the 62 mapped-core ACP modules persist; compatible extension named, with the exact `1.0.25` catalogue claim and the `1.0.4`/`1.0.5` registered-tool courier independently bounded; production claims unchanged
- [2026-09-14 Ollama 0.34.0 Claim](./2026-09-14-ollama-0-34-0-claim.md) — g05.063 raised `ollama.runtime` through official `0.33.2` as a compatible extension with a named `0.33.3` stop on the additive cached-count metrics key; `0.33.3` and `0.34.0` stay `UnverifiedNewer`, exclusions, behavior, specimen, and `AllowUnverified` kept
- [2026-09-14 Ollama 0.34.0 Identity](./2026-09-14-ollama-0-34-0-identity.md) — Research 313 froze all five published hops from qualified `0.32.15` to official `0.34.0` with tag/commit/tree and selected-file hashes; eight selected structs byte-identical through `0.34.0`, routes identical through `0.33.2`; compatible extension through `0.33.2` named with a `0.33.3` stop on the additive cached-count metrics key; production claims unchanged
- [2026-09-21 Cursor Agent 2026.09.18 Claim](./2026-09-21-cursor-agent-2026-09-18-claim.md) — raised `cursor-agent.release-date` through official `2026.09.18-9a7762b`; qualified published hops `2026.09.15-d2fe57e` and `2026.09.18-9a7762b`, kept inter-date gaps incompatible, synthetic `2026.09.19` `UnverifiedNewer`, and older published `2026.08.25` / `2026.09.08` independently unqualified
- [2026-09-21 Cursor Agent 2026.09.18 Identity](./2026-09-21-cursor-agent-2026-09-18-identity.md) — Research 343 froze both published hops from qualified `2026.09.10-fd3934a` to official `2026.09.18-9a7762b` with a complete tree inventory; selected CLI, ACP initialize subset, and stream-json keys persist; negotiated `sessionCapabilities.subagents` stays unmapped; compatible extension named
...
- [2026-09-14 Claude Agent ACP 0.76.0 Claim](./2026-09-14-claude-agent-acp-0-76-0-claim.md) — raised `claude-agent.acp-adapter` through official `0.76.0` (`0.66.0..=0.76.0`); qualified the four published hops `0.74.0`/`0.75.0`/`0.75.1`/`0.76.0`, kept `0.58.0`/`0.73.1`/`0.74.1`/`0.75.2`/`0.76.1` incompatible, synthetic `0.77.0` `UnverifiedNewer`, and `AllowUnverified`; mode, permissions, config-id, elicitation, and tool modules byte-identical; hidden-auth, authStatus, compaction, usage-markdown, fork, clear-context, and recommended-value deltas unmapped
- [2026-09-14 Claude Agent ACP 0.76.0 Identity](./2026-09-14-claude-agent-acp-0-76-0-identity.md) — Research 309 froze all four published hops from qualified `0.73.0` to official `0.76.0`, proved `0.73.1`/`0.74.1`/`0.75.2`/`0.76.1`/`0.77.0` unpublished, and classified the family as a compatible extension of initialize-meta-extensions-v7 from a complete dist inventory; mode, permissions, config-id, elicitation, and tool modules are byte-identical, and hidden-auth, authStatus, compaction, usage-markdown, fork, clear-context, and recommended-value deltas stay unmapped; production claims unchanged
- [2026-09-14 Claude Code 2.1.270 Claim](./2026-09-14-claude-code-2-1-270-claim.md) — raised headless `2.1.220..=2.1.270` and response-only `2.1.227..=2.1.270` as compatible extensions; qualified all eleven published hops, kept `2.1.244`/`2.1.249`/`2.1.253`–`2.1.256` and newly observed `2.1.262`/`2.1.264` incompatible, synthetic `2.1.271` `UnverifiedNewer`, watcher exact `2.1.251`, and every feature-specific exact set unchanged
- [2026-09-14 Claude Code 2.1.270 Identity](./2026-09-14-claude-code-2-1-270-identity.md) — Research 307 froze all eleven published hops from qualified `2.1.257` to official `2.1.270`, proved `2.1.262`/`2.1.264` unpublished, and classified both existing stream-JSON axes as a compatible extension from embedded-source mapped-surface evidence; host `2.1.258` help equals the frozen `2.1.257` digest; production claims unchanged
- [2026-09-13 v0.5.1 Annotated Source Tag](./2026-09-13-v0-5-1-annotated-source-tag.md) — operator-authorized annotated tag `v0.5.1` created and pushed at exact candidate `e9140b46` (tag object `97a6933a`, tree `d375b322`); exact annotation, single-ref push, local/remote agreement; qualifying run 34731113171 and tag-triggered run 34743711387 both green 11/11; qualified `crates/` and Grok trees unchanged; no registry, GitHub Release, or artifact; documentation closeout queued for exact-head review
- [2026-09-13 g05.054 v0.5.1 Release Candidate Merge](./2026-09-13-g05-054-v0-5-1-release-candidate-merge.md) — PR #317 merged candidate `755a2669` at `e9140b46` after independent exact-head review `5649975685`: coordinated `0.5.1` over byte-identical Desktop-qualified `crates/`, tag-equal `v0.5.0` baselines, truthful 50-route note, exact-head CI green twice; merge tree identical; two non-blocking observations deferred; tag gate returns to Tom
- [2026-09-13 g05.054 v0.5.1 Release Candidate](./2026-09-13-g05-054-v0-5-1-release-candidate.md) — source-only patch candidate prepared over immutable `v0.5.0`: OpenCode HTTP `1.18.30` plus the Grok `1.0.25` catalogue with additive route 50; every `crates/` path byte-identical to Desktop-qualified `0209dd7f`; two named `v0.5.0` baselines restored byte-for-byte from the tag with additions carried into fresh `0.5.1` baselines; front-door route assertion corrected; one failed prepare diagnosed and rerun per the amended recoverable-prepare rule; all seven gates and the full candidate board green; tag withheld
- [2026-09-13 g05.053 Grok 1.0.25 Catalogue Merge](./2026-09-13-g05-053-grok-1-0-25-catalogue-merge.md) — PR #316 merged at `3e9f29e7` after independent exact-head review `5649291554`: exact `1.0.25` `--no-auto-update models` admitted as an authenticated non-inference metadata operation with the shipped bullet grammar and accepted final capsule; two cosmetic non-blocking observations deferred; no ready task remains
- [2026-09-12 g05.053 Grok 1.0.25 Catalogue Correction](./2026-09-12-g05-053-grok-1-0-25-catalogue-correction-claim.md) — corrected the g05.052 non-admission: exact `1.0.25` `--no-auto-update models` admitted as an authenticated non-inference metadata operation under `HarnessConfigurationPosture::Ambient`, with the shipped bullet grammar, redacted bounded capture, no prompt/session/tool/inference, and joined cleanup; Research 306; ACP execution, `grok_build_model_for_version`, tagged `v0.5.0`, and Research 281 unchanged; route 50 additive post-`v0.5.0`
- [2026-09-12 g05.052 Grok 1.0.25 Model Catalogue Ruling](./2026-09-12-g05-052-grok-1-0-25-model-catalogue-ruling.md) — typed non-admission on PR 315 review: `models` admits online catalog fetches with no bindable suppression and the argv omitted `--no-auto-update`; no catalogue claim; ACP execution, `grok_build_model_for_version`, and `v0.5.0` unchanged; superseded by the g05.053 correction note (Contract 020's corrected authenticated-metadata boundary admits the prompt-free command)
...
- [2026-09-05 g05.009 Card 097 Closeout](./2026-09-05-g05-009-card-097-closeout.md) — Candidate L accepted and merged through PR 234; Contract 061 now proves all 767 rows, and the per-turn audit note was pruned after closeout
...
- [2026-09-05 g05.030 v0.4.1 Release Readiness Compiled](./2026-09-05-g05-030-v0-4-1-release-readiness-compiled.md) — card 080 delivered the Claude SDK editing session; cards 090-092 compiled on the v0.4.0 precedent with a feature freeze
- [2026-09-05 v0.4.1 Annotated Tag And Post-Release Runway](./2026-09-05-v0-4-1-annotated-tag.md) — operator-authorized annotated `v0.4.1` created and pushed at exact `c3cce750`; tag object `c888b2dc`; merged-SHA CI and the clean source consumer passed; feature freeze lifted
...
- [2026-09-04 g05.009 Card 074 DeepSeek Candidate I Closeout](./2026-09-04-g05-009-card-074-deepseek-closeout.md) — exact Candidate I tranche accepted and merged through PR 217 as `8cb811f2`; Contract 061 coverage is now 425 proved rows
...
- [2026-09-03 g05.021 Card 051 Lock Sync Prerequisite](./2026-09-03-g05-021-card-051-lock-sync-prerequisite.md) — first authorized prepare exposed stale workspace lock; second exposed parallel watcher path reuse; third exposed an OpenCode deadline/response race; accepted Effigy plus deterministic fixtures enabled the final green one-shot prepare
- [2026-09-03 g05.021 Card 050 v0.4.0 Freeze Audit](./2026-09-03-g05-021-card-050-v0-4-0-freeze-audit.md) — fresh exact-head audit at `b7f804b5`; 826 commits and 2,694 changed files; complete 40-package API and 49-row route/behavior ledgers; immutable 47-route and historical-baseline proof; accepted via PR 198 exact head `2f4923b8`, merged as `835fe9ff`
- [2026-09-03 g05.022 Card 055 Claude Agent SDK Restoration](./2026-09-03-g05-022-card-055-claude-agent-sdk-restoration.md) — `claude-agent.sdk` restored from canonical main and merged through PR 196 at `493f8194`; reap authority reserved before every effect; one enclosing guardian owns pump, process, and both leases through the ordered continuation; caller expiry transfers the guardian, never the pump; real `LocalHostServices` integrated proof; `v0.4.0` unpaused with card 050 ready
- [2026-09-03 Claude Agent SDK 0.3.259 Identity](./2026-09-03-claude-agent-sdk-0-3-259-identity.md) — official `0.3.259` and native `2.1.259` frozen through a deterministic 15-file package-tree inventory; rechecked and still `latest`/`next` before the card 055 restoration
- [2026-09-03 g05.025 Card 061 Reserved Reapable Task Runtime](./2026-09-03-g05-025-card-061-reserved-reapable-task-runtime.md) — pre-effect exact-host/scope reap reservation; shutdown-safe non-fallible later handoff; cancelled reserved join retains host ownership; deterministic real local-host lifecycle proof; card 055 unfrozen once this merged at `53153af1`
...
- [2026-09-03 g05.023 Card 058 Caller-Bounded Interactive Session Cleanup](./2026-09-03-g05-023-card-058-caller-bounded-interactive-session-cleanup.md) — one caller-selected host deadline now bounds public interactive close and cleanup across all 22 interactive adapter packages; stalled interruption, escalation, task join, credential release, and resource release fail honestly at expiry; the zero-argument close API is removed with exact v0.4 evidence; g05.023 stops on the independent macOS owned-tree posture decision
- [2026-09-02 g05.023 Card 059 Unix Owned-Tree Attestation](./2026-09-02-g05-023-card-059-unix-owned-tree-attestation.md) — evidence stop; four native counterexamples falsify the candidate primitives (setsid escape, descriptor EOF with a live child, released-group identity, reparenting to launchd); no sound owned-tree observation was found within current ordinary host-local authority on macOS, so the host stays root-only and adds no unsafe; entitlement/system-extension mechanisms are out of scope, not proved nonexistent; the macOS SDK tree gate is an open operator decision
...
- [2026-09-02 Claude Agent ACP Parity Gate](./2026-09-02-claude-agent-acp-parity-gate.md) — card 054 complete; qualified ACP capability census closed; negotiated model-options observation is the only adapter-only next tranche; no production change
...
- [2026-08-31 g05.009 Card 030 Acknowledgement Reassessment Stop](./2026-08-31-g05-009-card-030-acknowledgement-stop.md) — evidence stop; D, F, and G all discard their acknowledgement on current `main`; no candidate promoted; g05.009 `strict-paused` behind the `claude-agent.acp` gate
- [2026-08-31 g05.009 Card 024 Package Completion](./2026-08-31-g05-009-card-024-package-completion.md) — PR 138 merged at `8b295e6b`; exact candidate H 38-row proof complete; acknowledgement reassessment card 030 ready
...
- [2026-08-30 g05.007 Card 020 Live Authorization](./2026-08-30-g05-007-card-020-live-authorization.md) — initial Darwin-only envelope superseded before provider contact; turn later consumed by the card 020 Linux live stop
...
- [2026-08-28 g04.090b Kiro ACP Agent-Profile Evidence](./2026-08-28-g04-090b-kiro-acp-agent-profile-evidence.md) — complete; card 257; Research 254 honest empty deliver-now set
...
- [2026-08-27 g04.082b Gemini CLI Headless Thinking Evidence](./2026-08-27-g04-082b-gemini-cli-headless-thinking-evidence.md) — complete; card 229; Research 230 honest empty deliver-now set
- [2026-08-27 g04.082c Bedrock Runtime Service-Tier Evidence](./2026-08-27-g04-082c-bedrock-runtime-service-tier-evidence.md) — complete; card 230; Research 231 honest empty deliver-now set
- [2026-08-27 g04.082d Ollama Attached Think Max Evidence](./2026-08-27-g04-082d-ollama-attached-think-max-evidence.md) — complete; card 231; Research 232 honest empty deliver-now set
