...
pub const CLAUDE_AGENT_ACP_LATEST_QUALIFIED_VERSION: &str = "0.79.0";
...
mod tests {
    ...
    fn claim_preserves_seven_milestones_exclusions_and_visible_newer_execution() {
        ...
        assert_eq!(claim.latest_qualified().as_str(), "0.79.0");
        ...
        for qualified in [
            ...
            "0.74.0", "0.75.0", "0.75.1", "0.76.0", "0.77.0", "0.78.0", "0.79.0",
        ] {
    ...
    fn session_config_gate_preserves_legacy_baseline_and_newer_inheritance() {
        ...
        assert!(version_supports_config_options(&version("0.71.0")));
        assert!(version_supports_config_options(&version("0.72.0")));
        assert!(version_supports_config_options(&version("0.73.0")));
        assert!(version_supports_config_options(&version("0.74.0")));
        assert!(version_supports_config_options(&version("0.75.0")));
        assert!(version_supports_config_options(&version("0.75.1")));
        assert!(version_supports_config_options(&version("0.76.0")));
        assert!(version_supports_config_options(&version("0.77.0")));
        assert!(version_supports_config_options(&version("0.78.0")));
        assert!(version_supports_config_options(&version("0.79.0")));
    }
