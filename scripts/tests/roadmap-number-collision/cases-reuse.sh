...
printf '\n# edited in place\n' >>"$collision_edit/docs/roadmaps/g04/076-kimi-platform-chat-addable-descriptor.md"
...
collision_git "$collision_unrelated" rm -q \
  docs/roadmaps/g04/076-kimi-platform-chat-addable-descriptor.md
collision_write_task \
  "$collision_unrelated" \
  docs/roadmaps/g04/076-unrelated.md \
  '# unrelated 076'
...
collision_git "$collision_rename" mv \
  docs/roadmaps/g04/076-kimi-platform-chat-addable-descriptor.md \
  docs/roadmaps/g04/076-kimi-platform-renamed.md
...
collision_git "$collision_edited" mv \
  docs/roadmaps/g04/076-kimi-platform-chat-addable-descriptor.md \
  docs/roadmaps/g04/076-kimi-platform-retitled.md
printf '\n# retitled and edited\n' >>"$collision_edited/docs/roadmaps/g04/076-kimi-platform-retitled.md"
...
collision_write_task \
  "$collision_serial" \
  docs/roadmaps/g04/079-claude-code-2-1-238-identity.md \
  '# 079 Claude Code identity'
collision_write_task \
  "$collision_serial" \
  docs/roadmaps/g04/080-claude-code-2-1-238-claim.md \
