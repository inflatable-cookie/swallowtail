...
- [142-claude-sdk-admitted-instance-worked-example.md](./142-claude-sdk-admitted-instance-worked-example.md) — ready; Desktop cannot compose an SDK admitted instance with registered tools from anything we ship; the example I cited is for a different route
...
- [140-grok-probe-live-bounds.md](./140-grok-probe-live-bounds.md) — complete; PR 288 merged at `735eab70`; every probe bound re-derived for a live model, and truncation elides chatter instead of the answer
...
- [070-contract-061-provider-operation-observation-gate.md](./070-contract-061-provider-operation-observation-gate.md) — complete; promoted into Contract 061 and runtime/testkit card 073
...
- [066-contract-061-candidate-i-breadth-audit.md](./066-contract-061-candidate-i-breadth-audit.md) — complete; 47 rows; shared observation blocker resolved by card 073; promoted as card 074
...
- [007-claude-code-watcher-seam-evidence.md](./007-claude-code-watcher-seam-evidence.md) — completed; Research 257 admits the complete Claude seam
- [004-qoder-effective-skill-roster-evidence.md](./004-qoder-effective-skill-roster-evidence.md) — completed; Research 256 returns an honest empty set
