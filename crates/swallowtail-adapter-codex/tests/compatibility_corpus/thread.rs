...
fn thread_catalogue_corpus_freezes_the_complete_import_floor() {
    ...
    assert_eq!(corpus["qualified_range"]["latest"], "0.154.0");
    assert_eq!(
...
fn thread_reconciliation_corpus_separates_exact_and_session_scoped_truth() {
    ...
    assert_eq!(corpus["latest_qualified"], "0.154.0");
...
fn thread_catalogue_milestones_have_exact_release_and_source_identity() {
    ...
    assert_eq!(
        ...
        [
            ...
            "0.147.0", "0.148.0", "0.149.0", "0.149.1", "0.150.0", "0.150.1", "0.151.0", "0.152.0", "0.152.1", "0.153.0", "0.153.1", "0.153.2", "0.153.3", "0.153.4", "0.154.0"
        ]
    );
