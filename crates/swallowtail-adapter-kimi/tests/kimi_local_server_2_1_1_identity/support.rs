...
pub(super) const IDENTITY: &str = include_str!("../fixtures/kimi-local-server-2.1.1/identity.json");
pub(super) const PROTOCOL: &str = include_str!("../fixtures/kimi-local-server-2.1.1/protocol.json");
pub(super) const FROZEN_0_43_0_IDENTITY: &str =
    include_str!("../fixtures/kimi-local-server-0.43.0/identity.json");
