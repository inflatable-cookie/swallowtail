...
- Cards 098-100 ran `effigy validate:focused swallowtail-adapter-ollama`,
  `effigy package:verify-affected swallowtail-adapter-ollama`,
  `effigy check:examples`, and `effigy qa:routes` over the affected adapter
  surface.
- Deterministic corpus, protocol, preparation, and prepared-facade tests cover
  minimum, representative, and maximum admitted values without starting a
  runtime or sending a live model request.
