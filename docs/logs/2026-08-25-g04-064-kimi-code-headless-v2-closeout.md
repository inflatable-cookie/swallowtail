...
Status: complete; PR pending orchestrator review
Owner: Tom
Milestone: g04.064
Cards: 179-180
...
remains `kimi.headless.stream-json.v1`; exact `0.38.0` is
`kimi.headless.stream-json.v2` with facade `kimi-headless-stream-json-v2`.
...
g04 remains open at operator direction. Contract 029 currentness stays
standing. The next programme move is not auto-selected here.
