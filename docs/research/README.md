...
- [214 Pi RPC 0.84.3 Identity](./214-pi-rpc-0-84-3-identity.md) — promoted through g04.067 cards 187-188; official npm `0.84.3` is a compatible extension of `0.84.0..=0.84.2` message-update-delta
...
- [214 OpenCode HTTP Web-Search Evidence](./214-opencode-http-web-search-evidence.md) — reserved for g04.067 card 187; no version, provider/backend, permission, profile, or policy row prequalified
