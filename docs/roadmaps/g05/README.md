...
- [g05.003 Operation-Scoped Watcher Proof](003-operation-scoped-watcher-proof.md) — ready; card 010 complete for exact `2.1.251` credential-free binding; card 011 keeps the separate live gate
...
not admit a watcher range or support claim. Card 011 alone keeps the
separately authorized live same-turn gate and first route claim.
...
- [003 Operation-Scoped Watcher Proof](./003-operation-scoped-watcher-proof.md) — ready; card 010 complete for exact `2.1.251` binding; card 011 waits on live authorization
