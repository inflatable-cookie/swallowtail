...
#[test]
fn production_claim_matches_the_frozen_candidate_ceiling() {
    assert_eq!(CLAUDE_AGENT_ACP_LATEST_QUALIFIED_VERSION, "0.64.0");
    let claim = claude_agent_acp_claim();
    for candidate in ["0.62.0", "0.63.0", "0.64.0"] {
