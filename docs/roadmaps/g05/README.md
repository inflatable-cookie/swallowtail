...
- [g05.069 Command Code 1.54.0 Live Requalification](./069-command-code-1-54-0-live-requalification.md) — ready; compiled under Tom's 2026-09-17 re-confirmation of the exact-pin live gate for the version-bound feature and activity evidence
...
g05 has seventy-nine numbered tasks: 63 complete, including
standing currentness at 004, 005, 012, 013, 014, 015, 016, 018, 019, 020,
028, 037, 044, 051, and 079, the A2 ACP cap at 017, contract promotion at 008 and 010,
dual-route parity
at 022, shared
...
- [079 Oh My Pi 18.1.22 Major-Line Qualification](./079-oh-my-pi-18-1-22-major-line-qualification.md) — completed; nineteenth and final Research 308 family; Research 327 froze all 36 published stables `17.4.1` through `18.1.22` with reproduced registry, tarball, `dist/cli.js`, file-count, and tag-commit identity plus one deterministic shipped-tree inventory, extended the retained `17.x` segment to `17.2.9..=17.4.2` on the unchanged `oh-my-pi.rpc-v2-v17.2.9` revision, and admitted `18.0.0..=18.1.22` on the distinct `oh-my-pi.rpc-v2-v18.0.0` revision under claim id `oh-my-pi.rpc.package-window-2` with `18.0.2`/`18.1.7` excluded and `17.4.3`/`17.4.4` incompatible
...
- [069 Command Code 1.54.0 Live Requalification](./069-command-code-1-54-0-live-requalification.md) — ready; compiled under Tom's 2026-09-17 re-confirmation of the exact-pin live gate for version-bound feature and activity evidence
