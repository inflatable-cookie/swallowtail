...
- `docs/knowledge/contracts/054-paged-provider-session-history.md`
- `docs/knowledge/contracts/017-provider-owned-session-load-replay-and-host-containment.md`
- `docs/knowledge/contracts/048-cross-process-active-operation-reconciliation.md`
- `docs/knowledge/architecture/system-architecture.md`
- task g03.057 (removed at the lean Northstar cut; see Git history before `49b0d308`)
