...
fn app_server_corpus_keeps_stable_experimental_and_milestones_separate() {
    ...
    assert_eq!(
        ...
        [
            "0.110.0", "0.120.0", "0.131.0", "0.140.0", "0.144.6", "0.145.0", "0.146.0", "0.147.0", "0.148.0", "0.149.0", "0.149.1", "0.150.0", "0.150.1", "0.151.0", "0.152.0", "0.152.1"
        ]
    );
    ...
    for release in releases {
        ...
        if matches!(
            version,
            "0.131.0" | "0.140.0" | "0.144.6" | "0.145.0" | "0.146.0" | "0.147.0" | "0.148.0" | "0.149.0" | "0.149.1" | "0.150.0" | "0.150.1" | "0.151.0" | "0.152.0" | "0.152.1"
        ) {
        ...
        if matches!(version, "0.144.6" | "0.145.0" | "0.146.0" | "0.147.0" | "0.148.0" | "0.149.0" | "0.149.1" | "0.150.0" | "0.150.1" | "0.151.0" | "0.152.0" | "0.152.1") {
