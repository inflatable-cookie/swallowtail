...
| `qwen.headless` | `not-applicable` | `no` | `not-applicable` | `not-applicable` | `not-applicable` | `not-applicable` | deprecated `0.19.11..=0.20.1` and `0.21.0..=0.21.14`; exact maintained `0.21.15` plus same-revision maintained `0.22.0..=0.24.2`; unpublished `0.21.16` incompatible; current structured-run operation has no provider session | run and process cleanup only |
