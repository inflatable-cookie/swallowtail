...
7. [ ] Promote Research 249 and complete the reserved lane log. Do not edit
       shared milestone, inventory, programme, triage, matrices, or indexes.

## Acceptance Criteria

- [ ] exact version/mode/resource/tool/lifecycle table or honest empty set exists
- [ ] a non-empty row closes authority, application, terminal, cleanup, and omission
- [ ] no row silently widens write, tool, approval, or isolation authority
- [ ] `bypassPermissions` is not admitted or made a default
