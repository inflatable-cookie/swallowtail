...
- [215 Qwen Headless 0.22.1 Identity](./215-qwen-headless-0-22-1-identity.md) — promoted through g04.068 cards 190-191; official npm `0.22.1` via published `0.22.0` is a compatible extension of exact `0.21.15` reasoning-control; unpublished `0.21.16` stays a gap
