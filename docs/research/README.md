...
- [226 Claude Code Headless Maximum-Turn Evidence](./226-claude-code-headless-maximum-turns-evidence.md) — reserved for g04.079 card 219; exact qualified-artifact support, native loop enforcement, environment precedence, and limit-reached terminal truth gate delivery
