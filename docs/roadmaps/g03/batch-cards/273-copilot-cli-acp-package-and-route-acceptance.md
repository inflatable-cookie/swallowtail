# 273 GitHub Copilot CLI ACP Package And Route Acceptance

Status: planned
Owner: Tom
Created: 2026-08-18
Milestone: `../089-copilot-cli-acp-route.md`
Depends on: Card 272; Contracts 036-037, 044-045, 051-052

## Goal

Complete production-facing documentation and acceptance for `copilot-cli.acp`, or record a negative/deferred disposition.
...
`effigy validate:focused swallowtail-adapter-copilot`; `effigy package:verify-affected swallowtail-adapter-copilot`; `effigy check:examples`; `effigy qa:docs`.
...
Cards 270-272; Research 143; Contract 052
