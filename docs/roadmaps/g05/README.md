...
| Prove one skill-discovery route and one watcher-enforcement route without flattening provider behavior. | Qoder and first Claude live proofs stopped; credential-free watcher repair ready | Contracts 058-060; Research 256-260; card 011 live stop; g05.006 card 019 | `g05.002`, `g05.003`, and `g05.006` |
...
- [g05.006 Watcher Proof Repair](006-watcher-proof-repair.md) — ready; card 019 repairs lossless activity and the future-live Stop oracle without provider contact
...
g05 has six numbered roadmaps: three completed milestones including standing
currentness at 005, honest evidence stops at 002 and 003, and one ready
milestone at 006.
...
independent of provider stdout cadence. g05.006 card 019 is ready to salvage
the credential-free value from the prototype, use the runtime projector, make
workspace cleanup panic-safe, and build a direct Stop/same-session proof oracle
without contacting Claude or publishing a route claim.
...
- [006 Watcher Proof Repair](./006-watcher-proof-repair.md) — ready; card 019; no provider authorization
