...
pub const GROK_BUILD_ACP_LATEST_QUALIFIED_VERSION: &str = "1.0.40";
...
mod tests {
    ...
    #[test]
    fn segments_cover_0_2_windows_and_1_0_4_through_1_0_40() {
        let claim = grok_build_acp_claim();
        for candidate in [
            "0.2.114", "0.2.115", "0.2.116", "0.2.117", "1.0.4", "1.0.5", "1.0.6", "1.0.11",
            "1.0.17", "1.0.24", "1.0.25", "1.0.29", "1.0.30", "1.0.31", "1.0.40",
        ] {
        ...
        for later in ["1.0.41", "1.1.0"] {
            ...
            assert_eq!(newer.latest_qualified().as_str(), "1.0.40");
            assert_eq!(
