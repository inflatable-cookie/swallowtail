...
| Prove one skill-discovery route and one watcher-enforcement route without flattening provider behavior. | Qoder and first Claude live proofs stopped; credential-free watcher repair complete; live claim withheld | Contracts 058-060; Research 256-260; card 011 live stop; g05.006 card 019 | `g05.002`, `g05.003`, and `g05.006` |
...
g05 has six numbered roadmaps: four completed milestones including standing
currentness at 004 and 005, honest evidence stops at 002 and 003, and zero
ready milestones.
