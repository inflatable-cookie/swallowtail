...
- [2026-09-21 Ollama 0.34.2 Identity](./2026-09-21-ollama-0-34-2-identity.md) — Research 331 froze all four published hops from qualified `0.33.2` to official `0.34.2` with tag/commit/tree/tarball and selected-file hashes; seven selected structs byte-identical through `0.34.2`; compatible extension named after decoder-tolerance of `prompt_eval_cached_count`; production claims unchanged
