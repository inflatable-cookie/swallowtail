...
fn exec_corpus_freezes_baseline_checkpoints_and_rejections() {
    ...
    assert_eq!(
        ...
        [
            "0.122.0", "0.130.0", "0.140.0", "0.144.6", "0.145.0", "0.146.0", "0.147.0", "0.148.0", "0.149.0", "0.149.1", "0.150.0", "0.150.1", "0.151.0", "0.152.0", "0.152.1", "0.153.0", "0.153.1", "0.153.2", "0.153.3", "0.153.4", "0.154.0"
        ]
    );
