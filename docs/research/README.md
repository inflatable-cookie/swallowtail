...
- [299 Claude SDK Live MCP Startup Failure](./299-claude-sdk-live-mcp-startup-failure.md) — complete; Card 149 stopped at `mcp_server_failed` before its prompt; Card 150 owns provider-free courier/startup diagnosis and repair
