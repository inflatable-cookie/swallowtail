...
pub const OH_MY_PI_PACKAGE_LATEST_QUALIFIED_VERSION: &str = "17.4.0";
...
mod tests {
    ...
    #[test]
    fn claim_qualifies_17_2_9_through_17_4_0_and_keeps_later_stable_unverified() {
        let claim = oh_my_pi_rpc_claim();
