...
pub use grok_acp_client_mcp_probe::{
    ...
    InconclusiveCause, LIVE_SESSION_NEW_WAIT, LiveGrokAcpPeer, append_echo_mcp_transcript,
    create_echo_mcp_transcript, desktop_grok_acp_client_mcp_probe_is_gated_open,
    echo_mcp_helper_is_live, grok_acp_client_mcp_fixture_probe,
    ...
    grok_acp_client_request_reply, grok_acp_echo_mcp_reply, grok_acp_echo_mcp_stdio_frame,
    isolated_grok_home, open_desktop_live_grok_acp_peer, read_echo_mcp_transcript,
    run_grok_acp_client_mcp_probe, run_grok_acp_client_mcp_probe_with_transcript,
};
