...
use swallowtail_adapter_deepagents::{
    deepagents_acp_descriptor, deepagents_acp_package_binding,
...
impl FixtureHost {
    pub fn new(scenario: Scenario) -> Self {
        Self::with_agent_info(scenario, "deepagents-acp", "0.0.1")
    }

    pub fn with_version(scenario: Scenario, version: &str) -> Self {
        Self::with_agent_info(scenario, "deepagents-acp", version)
    }

    pub fn with_agent_info(scenario: Scenario, name: &str, version: &str) -> Self {
        Self {
...
fn fixture_failure() -> RuntimeFailure {
    RuntimeFailure::new(swallowtail_core::SafeDiagnostic::new(
        "fixture.deepagents_acp.failed",
        "Deep Agents ACP fixture failed",
    ))
}
