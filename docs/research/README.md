...
- [224 Cursor Headless Ask-Mode Evidence](./224-cursor-headless-ask-mode-evidence.md) — promoted evidence stop through g04.077 card 213; exact `--mode ask` parses and is immutable per print run on the four qualified builds, but applies only as agent-store metadata and an `AgentMode.ASK` wire field; empty deliver-now set; cards 214-215 blocked
