...
- [2026-09-12 g05.052 Grok 1.0.25 Model Catalogue Claim](./2026-09-12-g05-052-grok-1-0-25-model-catalogue-claim.md) — admitted exact `1.0.25` pre-session model catalogue as a separately prepared `ModelCatalog` operation under `QualifiedOnly`; ACP execution claim, `grok_build_model_for_version`, and `v0.5.0` unchanged; no catalogue execution or provider call
