...
`grok-build.executable`. `1.0.4` through `1.0.41` are the maintained window
and bind `grok-4.6`. Exact `0.2.117` keeps its private task-control behavior
revision. Mid-gap `0.2.118..=0.2.121` and unprobed `1.0.0..=1.0.3`
are incompatible.
...
`1.0.4` through `1.0.41` and permitted unverified-newer points that inherit that
