...
- [2026-09-03 g05.021 Card 051 Lock Sync Prerequisite](./2026-09-03-g05-021-card-051-lock-sync-prerequisite.md) — first authorized prepare rolled back after stale workspace lock blocked `--locked` lint; Effigy PR 89 merge `4c554135` adds package-identity-checked Cargo.lock sync to the three-mutation transaction; fresh authorization required after review and merge
