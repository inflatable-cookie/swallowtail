# 085 Antigravity 1.1.14 Useful Newer

Status: completed
Owner: Tom
Created: 2026-08-18
Depends on: Research 127; Research 142; g03.084
Vision tags: maintained compatibility, exact interfaces, currentness
Contract refs: 001, 011, 023, 029, 032-033, 037, 039, 043-044
Planning state: cards 258-259 completed

## Problem

Research 127 ranked remaining AllowUnverified families after Qwen.
Antigravity is exact `1.1.9` with AllowUnverified. This host is already
qualified `1.1.9`. Official GitHub `latest` is now `1.1.14`. Raising the
bound is useful-newer support, not a silent `latest` bump and not a
flatten onto Gemini.

## Generation Runway Goal

Freeze Antigravity host `1.1.9` / official `1.1.14` identity against the
`1.1.9` corpus, then raise the qualified ceiling only if that evidence
...
- [x] rank remaining AllowUnverified registry-newer families and pick
      Antigravity
- [x] freeze host `1.1.9` and official `1.1.14` identity, changelog, and
      selected help
- [x] raise catalogue and headless claims through `1.1.9..=1.1.14` on the
...
### Batch 85.1 — Identity Corpus

- [x] Execute card 258.
- [x] record host `1.1.9` and official `1.1.14` against exact `1.1.9`
- [x] name compatible-extension on the existing catalogue and stream-json
      revisions for card 259 without changing production claims

### Batch 85.2 — Claim And Acceptance

- [x] Execute card 259 after card 258 names compatible-extension.
- [x] extend Maintained `1.1.9..=1.1.14` on both claims
...
- [x] official `1.1.14` classifies as Qualified Maintained
- [x] published intermediates `1.1.10` through `1.1.13` classify as
      Qualified
...
g03.085 is complete. Research 127 AllowUnverified families except deferred
