//! Frozen mapped-surface ledger for the Grok Build ACP 1.0.30 run.
...
const ADDED_FROM_1_0_5: &[(&str, &[&str])] = &[
    (
        "1.0.10",
        &[
            "crates/codegen/xai-grok-shell-terminal/src/acp_terminal.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/status_line.rs",
        ],
    ),
    (
        "1.0.11",
        &[
            "crates/codegen/xai-grok-shell-terminal/src/acp_terminal.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/context_snapshot.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/parent_message.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/status_line.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/workflow_write_smoke_check.rs",
        ],
    ),
    (
        "1.0.12",
        &[
            ...
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/context_snapshot.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/parent_message.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/sampling_events.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/status_line.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/wait_interrupt.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/workflow_write_smoke_check.rs",
        ],
    ),
    (
    ...
    (
        ...
        &[
            ...
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/context_snapshot.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/parent_message.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/post_tool_use_delivery.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/sampling_events.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/status_line.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/turn_task.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/wait_interrupt.rs",
    ...
    (
        ...
        &[
            ...
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/parent_message.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/post_tool_use_delivery.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/rate_limit_waits.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/sampling_events.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/status_line.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/turn_task.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/wait_interrupt.rs",
    ...
    (
        ...
        &[
            "crates/codegen/xai-grok-shell-terminal/src/acp_terminal.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/background_tasks.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/cancel.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/context_snapshot.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/mcp_init.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/parent_message.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/post_tool_use_delivery.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/rate_limit_waits.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/sampling_events.rs",
    ...
    (
        ...
        &[
            ...
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/context_snapshot.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/mcp_init.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/memory_capture.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/memory_status.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/parent_message.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/post_tool_use_delivery.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/prompt_offload.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/rate_limit_waits.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/sampling_events.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/status_line.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/turn_task.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/v2_memory_dream.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/wait_interrupt.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/workflow_write_smoke_check.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_types.rs",
        ],
...
const REMOVED_FROM_1_0_5: &[(&str, &[&str])] = &[
    (
        "1.0.10",
        &["crates/codegen/xai-grok-shell/src/terminal/acp_terminal.rs"],
    ),
    (
        "1.0.11",
        &["crates/codegen/xai-grok-shell/src/terminal/acp_terminal.rs"],
    ...
    (
        "1.0.22",
        &[
            "crates/codegen/xai-grok-pager/src/app/acp_handler/subagent_lifecycle.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/tasks_cancel.rs",
            "crates/codegen/xai-grok-shell/src/terminal/acp_terminal.rs",
        ],
    ),
    ...
    (
        ...
        &[
            ...
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/laziness_classifier.rs",
            "crates/codegen/xai-grok-shell/src/session/acp_session_impl/tasks_cancel.rs",
            "crates/codegen/xai-grok-shell/src/terminal/acp_terminal.rs",
        ],
    ),
...
fn selected_surface_literals_are_frozen_and_identical_at_every_hop() {
    ...
    assert_eq!(
        present.len(),
        SELECTED_LITERALS.len() - UNDERSCORE_PREFIXED_ABSENT.len()
    );
...
#[test]
fn model_document_binds_grok_4_6_with_one_unmapped_metadata_delta() {
    let protocol = json(PROTOCOL);
    ...
    assert_exact_string_set(
        &document["unmapped_fields_delta"],
        &["models[].show_model_fingerprint"],
    );
    let digests = document["digests"].as_object().expect("digests");
    let first = "264d0f644b0c435b0be869c081ac08231a205ccacecc6a46df2a7426f550748a";
    let second = "9d6924ec760a94f91902f60adb8bcf2cd9d3ab86891a1c83e8c01a092e56490a";
    assert_eq!(digests.len(), 2);
    let first_hops: Vec<&str> = digests[first]
        .as_array()
        .unwrap()
        .iter()
        .map(|v| v.as_str().unwrap())
        .collect();
    let second_hops: Vec<&str> = digests[second]
        .as_array()
        .unwrap()
        .iter()
        .map(|v| v.as_str().unwrap())
    ...
    assert_eq!(
        first_hops,
        vec!["1.0.5", "1.0.6", "1.0.7", "1.0.8", "1.0.9", "1.0.10"]
    );
    assert_eq!(second_hops.len(), 20);
    assert_eq!(second_hops[0], "1.0.11");
    assert_eq!(second_hops[19], "1.0.30");
    for (version, entry) in protocol["per_hop"].as_object().unwrap() {
        let digest = entry["model_document_sha256"][0].as_str().unwrap();
        assert!(
            first_hops.contains(&version.as_str()) || second_hops.contains(&version.as_str()),
            "{version}"
        );
        let expected = if first_hops.contains(&version.as_str()) {
            first
        } else {
            second
        };
...
fn acp_module_inventory_keeps_the_mapped_core_and_classifies_additions() {
    ...
    let baseline: Vec<String> = protocol["per_hop"]["1.0.5"]["acp_module_paths"]
        .as_array()
        .unwrap()
        .iter()
        .map(|v| v.as_str().unwrap().to_owned())
        .collect();
    let added = map(ADDED_FROM_1_0_5);
    let removed = map(REMOVED_FROM_1_0_5);
