# g06.025 Pi RPC 0.86.1 Review Entry

Owner: Tom
Created: 2026-09-24
Depends on: Contract 029; completed g06.020 pilot; external PR #356
Vision tags: route currentness, external PR, review entry

## Outcome

Admit external PR #356 through Queue review entry, raising `pi.package` from
`0.85.1` toward current official (`0.86.1` at the PR).
...
- [x] PR #356 is open, non-draft and same-origin at head `ddbbfb56`.
...
- Renumber the PR's research record to **Research 344**, reserved for this
...
- **Completion:** independent exact-head review accepts the head with Research
  344, indexes and matrices reconciled against current `main`.
...
| --- | --- | --- |
| No record collides | The record keeps 331 or takes another lane's number | Research 344; every reference updated |
...
for `swallowtail-adapter-pi`, route and docs QA.
