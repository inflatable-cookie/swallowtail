...
Depends on: Card 280; Contracts 036-037, 044-045, 051-052

## Goal

Complete production-facing documentation and acceptance for `qoder.headless`, or record a negative/deferred disposition.
...
`effigy validate:focused swallowtail-adapter-qoder`; `effigy package:verify-affected swallowtail-adapter-qoder`; `effigy check:examples`; `effigy qa:docs`.
...
Cards 278-280; Research 143; Contract 052
