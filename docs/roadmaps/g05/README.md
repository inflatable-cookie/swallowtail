...
| Keep production route versions current one family at a time. | completed standing currentness; Claude Agent ACP through official `0.73.0`; Research 271 remaining next family is Claude Code `2.1.257` | Contract 029 identity-before-claim; Research 271-272; current-main validation | `g05.018` cards 044-045 |
...
g05 has eighteen numbered roadmaps: 13 completed milestones including
...
003, 007, and 011. Milestone 018 is complete: Claude Agent ACP qualifies
official `0.73.0`. Milestone 009 is planned and strict-paused on its operator
decision.
