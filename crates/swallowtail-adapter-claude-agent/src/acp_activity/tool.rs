...
use swallowtail_runtime::{
    ActivityContentChangeKind, ActivityKind, ActivityLabel, ActivityLifecyclePhase,
    ActivityObservation, ActivityStatus, RuntimeFailure,
};
...
impl AcpActivityProjection {
    ...
    pub(super) fn tool_update(
        ...
        let content = update
            .content_replacement
            .as_ref()
            .map(|content| tool_content(content, ActivityContentChangeKind::ReplacementSnapshot))
            .transpose()?
            .flatten();
