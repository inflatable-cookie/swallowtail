use super::OhMyPiActivityProjection;
use crate::protocol::{OhMyPiAgentEvent, OhMyPiRpcDecoder, OhMyPiRpcRecord};
use swallowtail_runtime::{ActivityKind, ActivityLifecyclePhase, ActivityStatus, RuntimeTurnId};

const ACTIVITY: &str = include_str!("../../tests/fixtures/oh-my-pi-rpc-17.2.9/activity.jsonl");

#[test]
fn exact_pi_corpus_projects_message_reasoning_tool_compaction_and_unknown() {
    let mut decoder = OhMyPiRpcDecoder::new();
    let mut projection = OhMyPiActivityProjection::new(
