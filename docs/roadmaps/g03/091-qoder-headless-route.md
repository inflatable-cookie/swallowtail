# 091 Qoder Headless Route

Status: planned
Owner: Tom
Created: 2026-08-18
Wave: Primary
Depends on: g03.090; g03.097 intake cards 260-261; Research 143
Research: 143
Route id: `qoder.headless`
Planning state: cards 278-281 planned

## Purpose

Add Qoder through its documented terminal-native headless automation surface.
...
Prove non-interactive execution, structured output or bounded terminal truth, worktree/resource authority, permissions, cancellation/deadline, and cleanup. Keep any separate ACP capability out of this route.
...
- [278](batch-cards/278-qoder-headless-identity-corpus.md)
- [279](batch-cards/279-qoder-headless-driver-core.md)
- [280](batch-cards/280-qoder-headless-prepared-facade.md)
- [281](batch-cards/281-qoder-headless-package-and-route-acceptance.md)
...
Worktree support is an authority boundary, not permission to add repository mutation policy.
...
- [Qoder CLI in scripts](https://docs.qoder.com/cli/run-in-scripts)
