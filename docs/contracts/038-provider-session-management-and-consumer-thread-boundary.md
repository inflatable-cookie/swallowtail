...
The qualified Claude Agent ACP `0.53.0..=0.61.0` range advertises independent
...
`ProviderHardDeleted`. Claude Agent `0.62.0` remains unverified-newer and does
not extend the guaranteed range.
