...
Depends on: Contract 029; Research 285; frozen OpenCode `1.18.28` corpora; official npm/GitHub `1.18.29`

## Goal

Freeze exact official identity and mapped artifact deltas for published
OpenCode stable `1.18.29`, then name one Contract 029 segment outcome
...
2. Extract the published hop after `1.18.28` into `/tmp`. Build exact file
...
5. Freeze Research 292 and a secret-free `opencode-1.18.29` identity corpus
...
- official npm/GitHub identity and the intermediate hop are reproducible
...
Compatible extension admitted. Research 292 and the secret-free
`opencode-1.18.29` corpus freeze official npm/GitHub identity for hop
