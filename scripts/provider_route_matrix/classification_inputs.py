no_classification_overrides = {
    ...
    ("usage_evidence", "opencode.acp"): "selected_surface_absence",
    ...
    ("structured_run", "opencode.acp"): "selected_surface_absence",
...
generation_control_classifications = {
    ...
    ("output_token_limit", "opencode.acp"): "selected_surface_absence",
    ("reasoning_selection", "copilot-cli.acp"): "selected_surface_absence",
    ("reasoning_selection", "opencode.acp"): "selected_surface_absence",
    ("structured_output", "copilot-cli.acp"): "selected_surface_absence",
    ("structured_output", "opencode.acp"): "selected_surface_absence",
...
input_callback_classifications = {
    ...
    ("attachments", "opencode.acp"): "selected_surface_absence",
    ("consumer_tool_exchange", "copilot-cli.acp"): "selected_surface_absence",
    ("consumer_tool_exchange", "opencode.acp"): "selected_surface_absence",
    ("permission_exchange", "copilot-cli.acp"): "selected_surface_absence",
    ("permission_exchange", "opencode.acp"): "selected_surface_absence",
    ("question_exchange", "copilot-cli.acp"): "selected_surface_absence",
    ("question_exchange", "opencode.acp"): "selected_surface_absence",
    ("external_search", "copilot-cli.acp"): "selected_surface_absence",
    ("external_search", "opencode.acp"): "selected_surface_absence",
...
session_continuity_classifications = {
    ...
    ("load_session", "opencode.acp"): "contract_or_corpus_required",
    ("resume_session", "copilot-cli.acp"): "contract_or_corpus_required",
    ("resume_session", "opencode.acp"): "contract_or_corpus_required",
    ("native_session_close", "copilot-cli.acp"): "upstream_unsupported",
    ("native_session_close", "opencode.acp"): "upstream_unsupported",
