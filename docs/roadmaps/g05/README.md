...
| Keep production route versions current one family at a time. | active campaign; thirteen families processed through Research 321; Goose stopped at the selected-route provider-auth failure change and keeps exact `1.46.0` pending an operator ruling; Kiro advanced to exact `2.21.4`; Mistral Vibe advanced to exact `2.25.4` with an adapter-private `--legacy-harness` argv pin; Command Code's separate live requalification remains named in g05.069; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308-321; Tom's 2026-09-14 direction | g05.074 |
...
- [g05.074 Deep Agents 0.1.30 Useful Newer](./074-deep-agents-0-1-30-useful-newer.md) — ready; compare all five official npm successors provider-free, preserve stale ACP-registry discovery metadata and the empty model-selection set, then advance one exact point or stop at the first mapped counterexample
...
g05 has seventy-four numbered tasks: 55 complete and one ready, including
...
- [074 Deep Agents 0.1.30 Useful Newer](./074-deep-agents-0-1-30-useful-newer.md) — ready; fourteenth Research 308 family; exact npm `0.1.25..=0.1.30` provider-free comparison with stale ACP-registry metadata and Research 206's empty model-selection set kept separate
...
<!-- northstar:lifecycle:begin schema=northstar.lifecycle.projection.v2 digest=sha256:58291337d1a709fc20354f59f22d5760ff9c56799c87a2d71a0930fae6ab0fcf -->
