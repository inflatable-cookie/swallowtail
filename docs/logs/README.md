...
- [2026-09-21 Grok Build ACP 1.0.40 Claim](./2026-09-21-grok-build-acp-1-0-40-claim.md) — raised `grok-build.executable` through official `1.0.40`; qualified all ten published stable hops, kept the baseline, deprecated `0.2.114..=0.2.117`, gaps, `grok-4.6` binding, and `AllowUnverified`, left unpublished `1.0.41` `UnverifiedNewer`, and left the exact `1.0.30` catalogue claim and the `1.0.4`/`1.0.5` registered-tool courier independent of the ACP window
- [2026-09-21 Grok Build ACP 1.0.40 Identity](./2026-09-21-grok-build-acp-1-0-40-identity.md) — Research 331 froze all ten published stables `1.0.31..=1.0.40` after qualified `1.0.30` with linux-x64 compared-platform identity, a darwin-arm64 cross-check that reproduces Research 314, a byte-identical selected-literal presence map, an unchanged `grok-4.6` model document, the 62 mapped-core ACP modules, and a complete shipped-file inventory; compatible extension named, with the exact `1.0.30` catalogue claim and the `1.0.4`/`1.0.5` registered-tool courier independently bounded; production claims unchanged
