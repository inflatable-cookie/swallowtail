...
- [055 Claude Agent SDK Provider-Free Foundation](batch-cards/055-claude-agent-sdk-provider-free-foundation.md) — blocked; preserved PR 188 restacked and repaired under the accepted macOS root-only degraded posture; one shared scoped-work relinquish seam remains
