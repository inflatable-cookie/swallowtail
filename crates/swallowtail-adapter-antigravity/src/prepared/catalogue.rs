use super::AntigravityPreparedCatalogueIntegration;
...
impl AntigravityPreparedCatalogueIntegration {
    pub fn prepare_catalogue(
        ...
        let instance = super::common::instance_with_capabilities(
            self.instance(),
        ...
        Ok(AntigravityPreparedCatalogue {
...
impl AntigravityPreparedCatalogue {
    ...
    pub fn list_models(
        ...
        let driver = crate::AntigravityCatalogueDriver::new(self.environment.clone());
