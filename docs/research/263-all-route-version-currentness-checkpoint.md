# 263 All-Route Version Currentness Checkpoint
...
After Codex `0.151.0` qualification, what are the current official stable
...
Observation date is 2026-09-01. Only `codex` was on `PATH`; its safe version
observation was `codex-cli 0.150.1`. Every other named executable below was
missing from `PATH`. A missing local install is an observation, not a
compatibility gap.
...
| ---: | --- | --- | --- | --- | --- |
| 1 | Qwen Code headless (`qwen.headless`) | `qwen` not on `PATH` | npm [`@qwen-code/qwen-code` `0.22.3`](https://registry.npmjs.org/@qwen-code%2Fqwen-code/latest), published 2026-08-28 | `0.19.11..=0.20.1` deprecated; `0.21.0..=0.21.14` deprecated; exact `0.21.15` and `0.22.0..=0.22.3` maintained; `0.21.16` gap; AllowUnverified | unchanged |
...
| 4 | Claude Agent ACP (`claude-agent.acp`) | `claude-agent-acp` not on `PATH` | npm [`@agentclientprotocol/claude-agent-acp` `0.70.0`](https://registry.npmjs.org/@agentclientprotocol%2Fclaude-agent-acp/latest), published 2026-08-18; GitHub [`v0.70.0`](https://github.com/agentclientprotocol/claude-agent-acp/releases/tag/v0.70.0) | `0.53.0..=0.70.0` excluding `0.58.0`; AllowUnverified | unchanged |
| 5 | Claude Code headless and response-only (`claude-code.headless`; `claude-code.response-only`) | `claude` not on `PATH` | npm [`@anthropic-ai/claude-code` `2.1.252`](https://registry.npmjs.org/@anthropic-ai%2Fclaude-code/latest), published 2026-08-31; GitHub [`v2.1.252`](https://github.com/anthropics/claude-code/releases/tag/v2.1.252) | headless `2.1.220..=2.1.251`; response-only `2.1.227..=2.1.251`; gaps `2.1.244` and `2.1.249`; AllowUnverified | visible unverified-newer |
...
| 8 | Pi coding agent RPC (`pi.rpc`) | `pi` not on `PATH` | npm [`@earendil-works/pi-coding-agent` `0.84.4`](https://registry.npmjs.org/@earendil-works%2Fpi-coding-agent/latest), published 2026-08-28 | maintained exact published points through `0.84.3`; `0.83.1` gap; AllowUnverified | visible unverified-newer |
| 9 | Pi coding agent SDK sidecar (`pi.sdk-sidecar`) | `pi` not on `PATH` | same upstream npm package currently `0.84.4`; sidecar has no separate current package channel | exact `0.84.2` sidecar package, exact Node `22.23.2`, sidecar wire, and source-tag axes; QualifiedOnly | record only; future range work deferred |
...
| 12 | Command Code headless (`command-code.headless`) | `command-code` not on `PATH` | npm [`command-code` `1.39.2`](https://registry.npmjs.org/command-code/latest), published 2026-08-31 | exact `1.15.1`; QualifiedOnly | record only; future range work deferred |
| 13 | Cursor Agent catalogue, ACP, and headless (`cursor-agent.catalogue`; `cursor-agent.acp`; `cursor-agent.headless`) | `cursor-agent` not on `PATH` | ACP registry [Cursor `2026.08.11`](https://cdn.agentclientprotocol.com/registry/v1/latest/registry.json); no later registry build | exact `2026.07.01-41b2de7`, `2026.07.23-e383d2b`, `2026.08.04-aaa8809`, and `2026.08.11-e8db854`; no inferred gap; AllowUnverified | unchanged |
...
| 24 | llama.cpp attached server (`llama-cpp.attached`) | `llama-server` not on `PATH` | GitHub latest release [`v0.3.0`](https://github.com/ggml-org/llama.cpp/releases/tag/v0.3.0), published 2026-08-25; release tag is not the selected build identity | exact attached build `b9910/f5525f7e7`; QualifiedOnly | record only; future range work deferred |
| 25 | llama.cpp owned server lifecycle (`llama-cpp.owned`) | `llama-server` not on `PATH` | same GitHub latest [`v0.3.0`](https://github.com/ggml-org/llama.cpp/releases/tag/v0.3.0); no build-to-claim inference | exact owned build `b10069/178a6c449`; QualifiedOnly | record only; future range work deferred |
| 26 | Muse Code headless (`muse-code.headless`) | signed payload not on `PATH`; mutable `muse` launcher not probed | no public package or release channel for the signed payload located; local authority remains the exact payload record | exact opaque `0.2.1-R1215.1`; QualifiedOnly; mutable launcher is not the execution target | unchanged |
...
| 28 | Kimi Code installed harness (`kimi-code.acp`; `kimi-code.headless`) | `kimi` not on `PATH` | npm [`@moonshot-ai/kimi-code` `0.39.1`](https://registry.npmjs.org/@moonshot-ai%2Fkimi-code/latest), published 2026-08-28; GitHub [`@0.39.1`](https://github.com/MoonshotAI/kimi-code/releases/tag/%40moonshot-ai/kimi-code%400.39.1) | ACP exact `0.28.1` plus `0.29.0..=0.38.0`; headless `0.29.0..=0.37.2` v1 plus exact `0.38.0` v2; AllowUnverified | visible unverified-newer |
| 29 | Kimi Code local server (`kimi-code.local-server`) | `kimi` not on `PATH` | same npm [`@moonshot-ai/kimi-code` `0.39.1`](https://registry.npmjs.org/@moonshot-ai%2Fkimi-code/latest) | exact `0.28.1` plus `0.29.0..=0.38.0`; AllowUnverified | visible unverified-newer |
...
| 31 | Oh My Pi RPC (`oh-my-pi.rpc`) | `omp` not on `PATH` | npm [`@oh-my-pi/pi-coding-agent` `18.0.11`](https://registry.npmjs.org/@oh-my-pi%2Fpi-coding-agent/latest), published 2026-08-29; major line reset from 17.x | maintained `17.2.9..=17.4.0`; later stable unverified only under ordered semantics; major reset requires identity evidence | record only; future range work deferred |
| 32 | Ollama native attached runtime (`ollama.attached`) | `ollama` not on `PATH` | GitHub release [`v0.33.2`](https://github.com/ollama/ollama/releases/tag/v0.33.2), published 2026-08-27 | `0.14.0..=0.32.15`; exclusions `0.32.2` and `0.32.10`; AllowUnverified | visible unverified-newer |
| 33 | Codex app-server and exec (`codex.app-server`; `codex.exec`) | `codex-cli 0.150.1` | npm [`@openai/codex` `0.152.0`](https://registry.npmjs.org/@openai/codex/latest), published 2026-09-01; GitHub [`rust-v0.152.0`](https://github.com/openai/codex/releases/tag/rust-v0.152.0), published 2026-09-01 | exec and app-server maintained through `0.151.0`; existing gaps `0.82.0..=0.83.0`, `0.108.0`, `0.109.0`, `0.149.2`, and `0.150.2`; AllowUnverified | material candidate |
...
| 36 | OpenCode HTTP server (`opencode.http`) | `opencode` not on `PATH` | npm [`opencode-ai` `1.18.25`](https://registry.npmjs.org/opencode-ai/latest), published 2026-08-28; GitHub [`v1.18.25`](https://github.com/anomalyco/opencode/releases/tag/v1.18.25) | published qualified segments through `1.18.20`; AllowUnverified | visible unverified-newer |
| 37 | Qoder headless (`qoder.headless`) | `qodercli` not on `PATH` | npm [`@qoder-ai/qodercli` `1.1.39`](https://registry.npmjs.org/@qoder-ai%2Fqodercli/latest), published 2026-09-01 | exact `1.1.25`; QualifiedOnly | record only; future range work deferred |
| 38 | Grok Build ACP (`grok-build.acp`) | `grok` not on `PATH` | npm [`@xai-official/grok` latest `1.0.13`](https://registry.npmjs.org/@xai-official/grok/latest), published 2026-08-28; `alpha` is `1.0.16` and ignored; ACP registry `1.0.16` is discovery metadata | deprecated `0.2.114..=0.2.117`; maintained `1.0.4..=1.0.5`; later stable unverified; do not flatten registry/alpha identity into npm `latest` | visible unverified-newer |
...
1. **Codex `0.152.0`** — the host is on the qualified `codex.cli` window at
   `0.150.1`, the official npm and GitHub stable point moved to `0.152.0`, and
   the current claim already permits an exact forward attempt. Published
   stable points after the current `0.151.0` ceiling contain `0.152.0` only.
   Existing gaps `0.149.2` and `0.150.2` remain incompatible. The next
   ordered stable `0.153.0` is not published; published
   `0.153.0-alpha.2` is ignored.

No second family is selected in this record. Claude Code, Pi, Kimi, OpenCode,
Ollama, Antigravity, and Grok remain visible ordered newer candidates for later
...
corpus work is authorized.

## Decision

Compile Codex `0.152.0` next through the Contract 029 Upgrade Workflow, one
...
provider; do not lift Gemini's deferral.
...
- [Research 127](./127-all-route-version-currentness-checkpoint.md),
  ...
  and [Research 262](./262-codex-0-151-0-identity.md).
...
- [Kimi Chat API](https://platform.moonshot.ai/docs/api/chat)
...
- frozen currentness records [127](./127-all-route-version-currentness-checkpoint.md),
  [159](./159-post-harness-expansion-version-currentness-checkpoint.md), and
  [262](./262-codex-0-151-0-identity.md)
