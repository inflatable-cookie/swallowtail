...
fn sidecar_command_failure_codes_match_the_rust_enumeration() {
    ...
    let rust_codes: BTreeSet<_> = [
        ...
        ClaudeAgentSdkFailureCode::SelectedSkillInvalid,
        ClaudeAgentSdkFailureCode::SelectedSkillDigestMismatch,
        ClaudeAgentSdkFailureCode::SelectedSkillLimitExceeded,
        ClaudeAgentSdkFailureCode::SelectedSkillReferenceInvalid,
        ClaudeAgentSdkFailureCode::SelectedSkillPayloadNotText,
