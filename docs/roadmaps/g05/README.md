...
| Keep production route versions current one family at a time. | active campaign; twelve families processed through Research 320; Goose stopped at the selected-route provider-auth failure change and keeps exact `1.46.0` pending an operator ruling; Kiro advanced to exact `2.21.4`; Command Code's separate live requalification remains named in g05.069; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308-320; Tom's 2026-09-14 direction | g05.073 |
