...
- [223 Cursor Headless Provider-Sandbox Evidence](./223-cursor-headless-provider-sandbox-evidence.md) — reserved for g04.076 card 210; exact qualified Cursor builds; `HarnessIsolation::ProviderEnforced` candidate only
