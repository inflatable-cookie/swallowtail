...
- [2026-09-21 Oh My Pi 18.2.7 Identity](./2026-09-21-oh-my-pi-18-2-7-identity.md) — Research 331 froze official npm/GitHub `18.2.7` and the eight published hops after `18.1.22`; selected JSONL wire is byte-identical; remaining mapped hops are unmapped; decision is compatible-extension, not a major-line reset
