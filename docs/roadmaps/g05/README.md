...
| Keep production route versions current one family at a time. | active campaign; Claude Agent ACP, Qwen Code, Codex, Cursor Agent, Ollama, Grok Build ACP, and Claude Agent SDK completed through `0.76.0`, `0.23.3`, `0.154.0`, `2026.09.10-fd3934a`, `0.33.2` with a named `0.33.3` decoder stop, `1.0.30`, and the exact `0.3.270`/`2.1.270` tuple with Research 301 bound to `0.3.259`/`2.1.259` and a live-requalification follow-up; the Grok Build catalogue is next as the eighth family; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308-315; Tom's 2026-09-14 direction | g05.065 |
...
- [065 Claude Agent SDK 0.3.270 Tuple Useful Newer](./065-claude-agent-sdk-0-3-270-tuple-useful-newer.md) — completed; PR pending; Research 315; exact tuple rebound to `0.3.270`/`2.1.270`; Research 301 stays bound to `0.3.259`/`2.1.259` with `live_tuple_not_compiled` gating
...
<!-- northstar:lifecycle:begin schema=northstar.lifecycle.projection.v2 digest=sha256:769f17bf41d3f3d0acbec06a25a860721b38394b62d99acdb1c68b1af896f4ce -->
