...
| Keep production route versions current one family at a time. | completed standing currentness; Claude Code through official `2.1.257`; Research 274 selects Codex `0.152.1` next; no claim changes | Contract 029 identity-before-claim; Research 271-274; current-main validation | `g05.019` cards 046-047 |
