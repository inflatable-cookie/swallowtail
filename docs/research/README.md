...
- [281 v0.3.3 To Candidate Compatibility And Freeze Audit](./281-v0-4-0-compatibility-and-freeze-audit.md) — fresh exact-head audit at `b7f804b5`; 826 commits and 2,694 changed files; 40 packages, immutable 47-route release inventory, 49 current integration/route rows; complete API, route, lifecycle, behavior, upgrade/rollback, and immutable-baseline ledgers; card 050 complete locally pending independent exact-head review
