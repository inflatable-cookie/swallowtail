# g06.003 Qoder Skill Visibility Acceptance

Status: planned; serial after g06.002
Owner: Tom
Created: 2026-08-28
Updated: 2026-09-17
Carried forward: g05.040 → g06.003 by the g05.084 rollover; no scope change
Depends on: g06.002; card 004 evidence; Contract 058
...
- [ ] g06.002 has landed (currently planned behind the empty disposition).
...
- **State:** planned; one lane; serial after g06.002; no concurrent siblings.
...
- **Reserved closeout surfaces:** `docs/roadmaps/README.md`, `docs/roadmaps/g06/README.md`, `docs/roadmaps/generation-index.md`, `docs/logs/README.md`.
...
- g06.002 has not landed: this task remains planned.
