...
| `cursor-agent.catalogue` | `swallowtail-adapter-cursor`; `swallowtail.cursor-agent.catalogue` | authenticated model catalogue; Cursor models stdio | approved executable and environment; provider-supported delegated Cursor subscription login | `cursor-agent.release-date`; exact `2026.07.01-41b2de7`, `2026.07.23-e383d2b`, `2026.08.04-aaa8809`, `2026.08.11-e8db854`, `2026.08.31-4057e58`, `2026.09.02-c22c1a3`, and `2026.09.10-fd3934a`; no inferred gap; later dates permitted as visible unverified newer | `prepare_cursor(Catalogue)` → `prepare_catalogue` → `list_models` | `CursorCatalogueDriver`; `ModelCatalogDriver` |
| `cursor-agent.acp` | `swallowtail-adapter-cursor`; `swallowtail.cursor-agent.acp` | durable interactive session; ACP v1 stdio | approved executable and environment; provider-supported delegated Cursor subscription login; explicit ambient read-write workspace authority | `cursor-agent.release-date`; exact `2026.07.01-41b2de7`, `2026.07.23-e383d2b`, `2026.08.04-aaa8809`, `2026.08.11-e8db854`, `2026.08.31-4057e58`, `2026.09.02-c22c1a3`, and `2026.09.10-fd3934a`; no inferred gap; later dates permitted as visible unverified newer | `prepare_cursor(Acp)` → `prepare_session` → `open_session` | `CursorAcpDriver`; `InteractiveSessionDriver` |
| `cursor-agent.headless` | `swallowtail-adapter-cursor`; `swallowtail.cursor-agent.headless` | explicit-model one-prompt structured run with optional typed bracket model parameters (`fast`, `context`, `effort`), qualified high-effort `ReasoningSelection` on named Opus tuples only, assistant, thinking, tool, result, and usage events; Cursor stream JSON over stdio | approved executable and environment; provider-supported delegated Cursor subscription login; explicit read-only plan mode or read-write authority; optional closed Cursor-local Ask read mode on read authority and exactly qualified releases only, at qualified dispatch without an enforced read-only boundary; optional sandbox not selected | `cursor-agent.release-date`; exact `2026.07.01-41b2de7`, `2026.07.23-e383d2b`, `2026.08.04-aaa8809`, `2026.08.11-e8db854`, `2026.08.31-4057e58`, `2026.09.02-c22c1a3`, and `2026.09.10-fd3934a`; no inferred gap; later dates permitted as visible unverified newer | `prepare_cursor(Headless)` → `prepare_run` → `start_run` | `CursorHeadlessDriver`; `StructuredRunDriver` |
...
| `cursor-agent.catalogue` | `not-applicable` | `no` | `not-applicable` | `not-applicable` | `not-applicable` | `not-applicable` | exact qualified `2026.07.01-41b2de7`, `2026.07.23-e383d2b`, `2026.08.04-aaa8809`, `2026.08.11-e8db854`, `2026.08.31-4057e58`, `2026.09.02-c22c1a3`, and `2026.09.10-fd3934a`; no inferred gap; later dates remain visible `UnverifiedNewer`; catalogue has no provider session | process cleanup only |
| `cursor-agent.acp` | `unsupported` | `no` | `unsupported` | `unsupported` | `unsupported` | `unsupported` | exact qualified `2026.07.01-41b2de7`, `2026.07.23-e383d2b`, `2026.08.04-aaa8809`, `2026.08.11-e8db854`, `2026.08.31-4057e58`, `2026.09.02-c22c1a3`, and `2026.09.10-fd3934a`; no inferred gap; later dates remain visible `UnverifiedNewer`; load suppresses history-read and per-turn replay failures, so advertisement cannot qualify continuation recovery or lifecycle management | connection, resource, process, and task cleanup only; provider session state is preserved |
| `cursor-agent.headless` | `unsupported` | `no` | `unsupported` | `unsupported` | `unsupported` | `unsupported` | exact qualified `2026.07.01-41b2de7`, `2026.07.23-e383d2b`, `2026.08.04-aaa8809`, `2026.08.11-e8db854`, `2026.08.31-4057e58`, `2026.09.02-c22c1a3`, and `2026.09.10-fd3934a`; no inferred gap; later dates remain visible `UnverifiedNewer`; durable provider state exposes no public session identity | process and task cleanup only; provider state is preserved |
