retained_execution_classifications = {
    ...
    ("retained_background_execution", "zcode.app-server"): "operation_shape_not_applicable",
    ("stream_reattachment", "zcode.app-server"): "operation_shape_not_applicable",
    ("provider_managed_recovery", "zcode.app-server"): "selected_surface_absence",
    ...
    ("retained_background_execution", "claude-code.headless; claude-code.response-only"): "operation_shape_not_applicable",
    ("stream_reattachment", "claude-code.headless; claude-code.response-only"): "operation_shape_not_applicable",
    ("provider_managed_recovery", "claude-code.headless; claude-code.response-only"): "upstream_unsupported",
...
working_resource_write_classifications = {
    ...
    ("bounded_workspace_text_write", "zcode.app-server"): "selected_surface_absence",
...
residual_contract_or_corpus = {
    ...
    ("interactive_session", "claude-code.headless; claude-code.response-only"),
