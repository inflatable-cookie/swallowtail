...
g04.066 is complete and merged through PR 65 at `46070dfd`: Research 213 admits
...
pointer. g04.069 standing currentness is complete: Research 216 and cards
192-193 qualify Qwen headless through official `0.22.1` without moving
...
g04.074 stopped after card 204: Research 221 admits no deliver-now Cline
headless provider/model row. Provider identity stays ambient without `-P`,
explicit `-m` is never validated against membership or the selected provider,
...
g05 has sixteen roadmaps: 10 completed milestones, one ready milestone at 016,
honest evidence stops at 002,
003, 007, and 011. Milestone 009 is planned and
strict-paused on its operator decision. Milestones
004, 005, 012, 013, 014, and 015 are completed standing currentness. Milestone 006 is completed
...
changes no claim. g05.016 card 041 then proved the headless
agent-core-v2 routing boundary is `0.33.0` and traced the `0.39.0` ACP
process-authority delta to no containment. Card 042 owns the resulting claim
edit. PR 130 merged exact reviewed head `63324b4f` through `3360d497`. No Darwin dispatch,
