...
- [2026-09-03 g05.022 Card 055 Claude Agent SDK Restoration](./2026-09-03-g05-022-card-055-claude-agent-sdk-restoration.md) — `claude-agent.sdk` restored from canonical main; reap authority reserved before every effect; one enclosing guardian owns pump, process, and both leases through the ordered continuation; caller expiry transfers the guardian, never the pump; real `LocalHostServices` integrated proof; `v0.4.0` still frozen
