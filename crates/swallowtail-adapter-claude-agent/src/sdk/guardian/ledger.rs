...
/// only a complete one. This is the same owned set an enclosing guardian
/// carries through the ordered continuation.
pub(crate) type Acquisitions = super::cleanup::Owned;
