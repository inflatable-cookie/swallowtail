...
| Keep production route versions current one family at a time. | Pi RPC `0.85.1` complete through PR 304; qualified ceiling now `0.85.1`; sidecar stays exact `0.84.2` | Contract 029 identity-before-claim; Research 268, 302; qualified Pi `0.85.1`; current official/host observations | g05.044 |
...
| Make a strict registered-tool Claude SDK session representable without a native tool remainder. | ready; provider-free; unblocked by completed g05.045 | Desktop g02.051 blocked capsule; Contracts 013, 017, 019, 041, and 063; 2026-09-10 operator direction | g05.046 |
...
- [g05.046 Claude SDK Registered-Only Session Profile](./046-claude-sdk-registered-only-session-profile.md) — ready; provider-free; unblocked by completed g05.045

g05 has forty-six numbered tasks: 33 complete including
...
dual-route parity
at 022, shared
lifecycle closure at 023-025, and provider-limitation reconciliation at 045;
honest
evidence stops at 002, 003, 007, 011, 029, 031, and 034; one ready task at
046 for the resulting registered-only profile repair; planned tasks remain
at 035, 039, 040,
041, and 042.
...
- [046 Claude SDK Registered-Only Session Profile](./046-claude-sdk-registered-only-session-profile.md) — ready; unblocked by completed g05.045; zero native tools with explicit registered-route resource access; provider-free
