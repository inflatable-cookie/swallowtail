...
- [305 Grok 1.0.25 Model Catalogue Evidence](./305-grok-1-0-25-model-catalogue-evidence.md) — complete through g05.052; exact installed `1.0.25` `models` command/output grammar and embedded default-model document frozen from static artifact inspection; non-prompt seam admitted with exact-version `QualifiedOnly` catalogue claim; no catalogue execution, provider call, or credential read
