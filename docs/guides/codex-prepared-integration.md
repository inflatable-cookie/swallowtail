...
`0.80.0..=0.81.0`, `0.84.0..=0.107.0`, and `0.110.0..=0.151.0`; support is
...
Unpublished `0.149.2` and `0.150.2` stay incompatible. Later stable
versions may remain visible `UnverifiedNewer` without gaining
capabilities.
...
`0.110.0..=0.151.0` expose the complete selected import chain. Earlier
