# g06 Carried Forward Route Truth And Registered Capability
...
Carry the unclosed g05 outcomes forward as the opening g06 set: the shared
registered-tool harness capability and producer boundary, the gated Qoder
skill-visibility pair, the persistent-permission producer seam, and the
remaining-ACP-routes registered-tool adoption. Each arrived from g05 with its
full outcome, rubric, acceptance, evidence, and stop conditions intact.

g06's wider focus is not set by this rollover. Chatterbox reconciles the
carried-forward set with the operator and settles any broader g06 goal
separately; this generation opens with no new product policy.

## Generation Runway

| Goal | State | Governing refs | First task |
| --- | --- | --- | --- |
| Deliver one provider-neutral registered tool/server boundary and route-exact Claude, Codex, and Grok adoption on the merged shared kernel. | planned; Batch A promoted; implementation authority still owed an independent review and canonical contract promotion | Spec 014; Contracts 012, 017, 019, 028, 029, 037, 041, 047, 051, 057, 058, 060-063; Research 288, 295, 301 | g06.001 |
| Bind the exact Qoder skill roster through Contract 058 when a non-empty Research 256 deliver-now disposition exists. | planned; gated on Research 256 | Contracts 020, 029, 032, 033, 037, 041, 047, 058; Research 256 | g06.002 |
| Close the first Contract 058 proof with route fixtures, guide coverage, and consumer-facing truth. | planned; serial after g06.002 | Contracts 020, 029, 032, 033, 037, 041, 047, 058 | g06.003 |
| Build the persistent permission grant producer seam if the operator promotes it. | planned; operator promotion absent; no dispatch authorization | Contract 041; the Card129 feature-matrix cross audit | g06.004 |
| Give the `client_mcp_servers` producer gap on the remaining ACP routes a durable, honest reference. | planned; consumer requirement and operator direction absent | shared registered-tool kernel; Contracts 012, 017, 019, 028, 029, 037, 041, 047, 051, 057, 058, 060-063 | g06.005 |

The Contract 029 standing currentness lane stays generation-independent and
does not keep g06 open. See [standing-lanes.md](../standing-lanes.md).

## Frontier

Only ready and planned tasks are actionable. The five carried-forward tasks
...
- [002 Qoder Effective Skill Visibility Binding](./002-qoder-effective-skill-visibility-binding.md) — planned; carried from g05.039; gated on a non-empty Research 256 deliver-now disposition
- [003 Qoder Skill Visibility Acceptance](./003-qoder-skill-visibility-acceptance.md) — planned; carried from g05.040; serial after g06.002
- [004 Persistent Permission Grant Admission](./004-persistent-permission-grant-admission.md) — planned; carried from g05.041; operator promotion absent
...
<!-- northstar:lifecycle:begin schema=northstar.lifecycle.projection.v2 digest=sha256:cf8569fbc9ee364486913fef6ac019dee8981adc6b639377923354b9be53a187 -->
...
| g06.018 | complete | none | 8 | sha256:cee049dae376a7b3ab7c1c34c0386fd98fefe4a79ea5c389b8f6c569f94377ae |
...
| g06.022 | complete | none | 8 | sha256:b1e92f67119c6ed11a75e1224da56229cfe8b3a130399c7672ba6733125e1f58 |
| g06.023 | complete | none | 8 | sha256:b15823efb01420d3d2553a7e9d9ddaa964df95b40fe3789da9648702ffed40db |
| g06.024 | complete | none | 8 | sha256:b27242799383b5a9fe1d9ef92e0858fe90adec53dddb6ef7f382f1986059e4c6 |
| g06.025 | complete | none | 8 | sha256:f4299e36f59f2bfc03fef46083d4c73b0cea60788e4b549e76b2012f76adc82e |
| g06.026 | complete | none | 8 | sha256:fffbb3c6f8d73e15f0fe2e31c00c10a6b77e1d0aa769cadb1ae5f6b3b7bc34ff |
