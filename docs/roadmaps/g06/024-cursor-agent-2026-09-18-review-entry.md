# g06.024 Cursor Agent 2026.09.18 Review Entry

Owner: Tom
Created: 2026-09-24
Depends on: Contract 029; completed g06.020 pilot; external PR #355
Vision tags: route currentness, external PR, review entry

## Outcome

Admit external PR #355 through Queue review entry, raising `cursor-agent.release-date` (catalogue, ACP and headless claims) from
`2026.09.10-fd3934a` toward current official (`2026.09.18-9a7762b` at the PR).
...
- [x] PR #355 is open, non-draft and same-origin at head `bce44fb7`.
...
- Renumber the PR's research record to **Research 343**, reserved for this
...
- **Completion:** independent exact-head review accepts the head with Research
  343, indexes and matrices reconciled against current `main`.
...
| --- | --- | --- |
| No record collides | The record keeps 331 or takes another lane's number | Research 343; every reference updated |
...
for `swallowtail-adapter-cursor`, route and docs QA.
