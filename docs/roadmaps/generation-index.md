...
g05 has five roadmaps: 3 completed milestones, honest evidence stops at 002
and 003. Milestone 005 is completed standing currentness.
g05.001 is
...
closed card 010 for exact `2.1.251` credential-free binding; card 011 stopped
after one authorized Haiku live turn that never showed a host watcher, so the
first route claim stays withheld. g05.004 standing
