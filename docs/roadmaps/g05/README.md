...
| Repair the Claude SDK live-open failure Bovine Desktop hit on `v0.4.1` and ship it as patch `v0.4.2` with cards 100 and 103 closed, card 101 candidate preparation complete, and card 102 ready. | tagged; `v0.4.2` at `f94dd16f`; cards 100, 101, and 103 closed; card 102 ready; card 082 branch-only | Contract 036; the 2026-09-05 Bovine report | `g05.032`, cards 100-103 |
