...
| Publish cohesive route-feature and control truth without adapter downcasts or execution-authority widening. | Contract 061 active; candidates A, D, G, and H complete through cards 022-024 and 031-032; 249 rows proved; candidate J audit 067 complete and promotable; audits 064-066 remain active; no implementation card is ready | reviewed 767-row census; Contracts 037, 047, 057, 061; accepted realization and PR-review decisions; Batch 9.1, 9.4, and Kimi gates | `g05.008` card 021; `g05.009` cards 022-024, 030-034, and 064-067 |
...
- [g05.009 Contract 061 Consumer Projection Realization](009-contract-061-consumer-projection-realization.md) — ready; cards 022-024 and 031-032 merged; candidate J audit 067 closed and promotable; audits 064-066 remain active; no implementation card is ready; card 034 is not ready
...
- [009 Contract 061 Consumer Projection Realization](./009-contract-061-consumer-projection-realization.md) — ready; candidate J audit 067 closed and promotable; audits 064-066 remain active; 249 rows proved; Kimi observation decision deferred behind card 064
