...
- [2026-09-02 Claude Agent SDK Foundation](./2026-09-02-claude-agent-sdk-foundation.md) — card 055; provider-free `claude-agent.sdk` route on exact SDK `0.3.258` and native `2.1.258`; policy and npm stable rechecked unchanged; credential non-custody mechanically checked; host-owned descendant-tree close reports graceful, escalated, or unconfirmed
