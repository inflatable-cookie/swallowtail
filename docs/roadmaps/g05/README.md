...
| Keep production route versions current one family at a time. | active campaign; Research 308 orders nineteen stale or gated families; Claude Agent ACP is first; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308; Tom's 2026-09-14 direction | g05.059 |
...
- [g05.059 Claude Agent ACP 0.76.0 Useful Newer](./059-claude-agent-acp-0-76-0-useful-newer.md) — ready; first serial Research 308 family; recheck official stable and qualify every published hop after `0.73.0`
...
- [059 Claude Agent ACP 0.76.0 Useful Newer](./059-claude-agent-acp-0-76-0-useful-newer.md) — ready; first serial Research 308 currentness family
