...
- [290 OpenCode HTTP 1.18.29 Identity](./290-opencode-http-1-18-29-identity.md) — extracurricular Contract 029; npm/GitHub identity and deterministic artifact delta frozen for `1.18.28` → `1.18.29`; compatible `surface-19` extension admitted; production claims unchanged until the extracurricular claim
