...
`b10069-178a6c449`. Optional `--ctx-size N` and `--reasoning off` are
adapter-local launch configuration; readiness still does not decode nested
`/props` `n_ctx`, and no readiness channel reports reasoning selection.
...
- <https://github.com/ggml-org/llama.cpp/blob/b10069/common/arg.cpp>
