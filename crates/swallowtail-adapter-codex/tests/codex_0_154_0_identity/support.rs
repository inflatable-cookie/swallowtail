...
pub(super) const IDENTITY: &str = include_str!("../fixtures/codex-cli-0.154.0/identity.json");
pub(super) const PROTOCOL: &str = include_str!("../fixtures/codex-cli-0.154.0/protocol.json");
pub(super) const DIST_INVENTORY: &str =
    include_str!("../fixtures/codex-cli-0.154.0/dist-inventory.json");
pub(super) const FROZEN_0_152_1_PROTOCOL: &str =
    include_str!("../fixtures/codex-cli-0.152.1/protocol.json");
