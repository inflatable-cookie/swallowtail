...
- [g05.076 Gemini CLI 0.59.0 Useful Newer](./076-gemini-cli-0-59-0-useful-newer.md) — ready; classify the three official stable hops after `0.56.0` independently for ACP and headless from exact npm/tagged-source evidence
...
g05 has seventy-six numbered tasks: 57 complete and one ready, including
...
- [076 Gemini CLI 0.59.0 Useful Newer](./076-gemini-cli-0-59-0-useful-newer.md) — ready; sixteenth Research 308 family; freeze exact `0.56.0..=0.59.0` identity and classify the three later stable hops independently for ACP and headless
