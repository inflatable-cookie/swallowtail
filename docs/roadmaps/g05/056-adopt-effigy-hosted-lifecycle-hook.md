...
- Commit one repository-specific projection target file. It declares
  ...
  docs/roadmaps/g05/README.md, with g05 active.
...
- **Reserved closeout surfaces:** .northstar/lifecycle/v1/tasks/g05.056.json,
...
3. Add .northstar/lifecycle/v1/projection-targets.json, retaining the two
   standard front doors and adding docs/roadmaps/g05/README.md; set
   active_generation to g05.
...
| Projections cover current authority | Active generation or either front door is absent | Target file names exactly all three paths and g05 |
