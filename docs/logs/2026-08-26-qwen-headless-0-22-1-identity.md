# 2026-08-26 Qwen Headless 0.22.1 Identity
...
`0.21.15`. Selected mapped flags, image-only catalogue filter, and
`set_effort` stay. `0.22.1` extras (MCP `versionNegotiation`, DashScope
`max` clamp, approval-mode parser refactor, Web Shell/review) stay
