...
pub const OH_MY_PI_PACKAGE_LATEST_QUALIFIED_VERSION: &str = "18.1.22";
...
/// behavior are unchanged through `18.1.22`, but the `17` to `18` boundary is
...
/// inheritance of the prior major window.
