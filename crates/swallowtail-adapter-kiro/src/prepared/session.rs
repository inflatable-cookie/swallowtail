...
/// Working resource for one bounded Kiro ACP session.
...
#[derive(Clone, Debug, Eq, PartialEq)]
/// Prepared Kiro ACP session ready for initialize plus one bounded prompt.
pub struct KiroPreparedSession {
...
impl KiroPreparedIntegration {
    ...
    pub fn prepare_session(
        ...
        let descriptor = crate::kiro_acp_descriptor();
...
fn access_requirement(integration: &KiroPreparedIntegration) -> AccessRequirement {
