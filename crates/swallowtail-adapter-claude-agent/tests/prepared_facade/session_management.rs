...
fn unverified_newer_delete_requires_explicit_acceptance_and_close_is_not_promoted() {
    ...
    let preparation_host = FixtureHost::new(Scenario::Version, "0.70.1");
    ...
    let session_host = FixtureHost::new(Scenario::Success, "0.70.1");
    ...
    let delete_host = FixtureHost::new(Scenario::Success, "0.70.1");
