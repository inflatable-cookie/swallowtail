...
| Keep production route versions current one family at a time. | active campaign; eight families completed through the exact versions recorded in Research 309-316; Command Code exact `1.54.0` is ready as the ninth family; its separate live requalification is named in g05.069; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308-316; Tom's 2026-09-14 direction | g05.068 |
...
- [g05.068 Command Code 1.54.0 Useful Newer](./068-command-code-1-54-0-useful-newer.md) — ready; provider-free 68-point exact-pin and evidence reconciliation
...
g05 has sixty-nine numbered tasks: 54 complete and one ready, including
...
g05.067 is complete: PR pending; Research 316 reproduced the Research 314
...
- [068 Command Code 1.54.0 Useful Newer](./068-command-code-1-54-0-useful-newer.md) — ready; exact-pin qualification across all 67 published successors with old live evidence kept version-bound
...
<!-- northstar:lifecycle:begin schema=northstar.lifecycle.projection.v2 digest=sha256:d427220a2b20b3776d76307bfa69af4088bd293d88f2a19981a445727278659c -->
