//! Shared fixture access for the Grok Build ACP 1.0.41 identity ledger.

use serde_json::Value;
use sha2::{Digest, Sha256};
use swallowtail_core::InterfaceVersion;

pub(super) const IDENTITY: &str = include_str!("../fixtures/grok-1.0.41/identity.json");
pub(super) const PROTOCOL: &str = include_str!("../fixtures/grok-1.0.41/protocol.json");
pub(super) const DIST_INVENTORY: &str = include_str!("../fixtures/grok-1.0.41/dist-inventory.json");
