...
- [063 Ollama 0.34.0 Useful Newer](./063-ollama-0-34-0-useful-newer.md) — completed; PR pending; Research 313; qualified official `0.33.0` through `0.33.2` with named `0.33.3` decoder stop
