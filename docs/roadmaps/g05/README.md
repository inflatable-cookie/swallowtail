...
- [g05.003 Operation-Scoped Watcher Proof](003-operation-scoped-watcher-proof.md) — ready; card 010 landed the exact `2.1.251` credential-free binding; card 011 has an explicit proof oracle and keeps the separate live gate
...
authority envelope and same-turn review oracle. It alone keeps the separately
authorized live gate and first route claim; no provider turn has run.
...
- [003 Operation-Scoped Watcher Proof](./003-operation-scoped-watcher-proof.md) — ready; card 010 landed the exact `2.1.251` binding; card 011 proof oracle is explicit and waits on live authorization
