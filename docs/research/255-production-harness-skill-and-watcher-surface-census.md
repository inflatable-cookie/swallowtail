...
- [Contract 013: operation isolation and cleanup](../contracts/013-operation-isolation-and-cleanup.md)
- [Contract 017: persistent session containment](../contracts/017-persistent-session-containment.md)
- [Contract 023: harness operation boundary](../contracts/023-harness-operation-boundary.md)
- [Contract 029: version qualification](../contracts/029-version-qualification.md)
- [Contract 044: observable activity](../contracts/044-observable-agent-activity.md)
- [Contract 047: configured provider catalogue](../contracts/047-configured-provider-catalogue.md)
