...
| Keep production route versions current one family at a time. | active campaign; ten families processed through Research 318; Qoder stopped at the selected-route `--max-turns` authority change and keeps exact `1.1.25` pending an operator ruling; Goose exact `1.50.0` is ready as the eleventh family; Command Code's separate live requalification remains named in g05.069; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308-318; Tom's 2026-09-14 direction | g05.071 |
...
- [g05.071 Goose 1.50.0 Useful Newer](./071-goose-1-50-0-useful-newer.md) — ready; provider-free five-tag exact-pin and ACP boundary reconciliation
...
g05 has seventy-one numbered tasks: 55 complete and one ready, including
...
- [071 Goose 1.50.0 Useful Newer](./071-goose-1-50-0-useful-newer.md) — ready; exact-pin qualification across all four published successors with serve, builtin, provider, and advertised ACP operations kept independent
...
<!-- northstar:lifecycle:begin schema=northstar.lifecycle.projection.v2 digest=sha256:120fb02e6d1a1a3a63e40cfb2293b9c7e5381aa93ac8d59faea8d6da3a18d6a0 -->
