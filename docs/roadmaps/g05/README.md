...
- [g05.078 Kimi Code 0.43.0 Local-Server Containment](./078-kimi-code-0-43-0-local-server-containment.md) — ready; reuse Research 282/325 identity, land the evidenced safe `0.39.x` prefix, classify containment through `0.43.0`, and change the claim so uncontained later points fail closed
...
g05 has seventy-eight numbered tasks: 59 complete and one ready, including
...
<!-- northstar:lifecycle:begin schema=northstar.lifecycle.projection.v2 digest=sha256:ad6996f4b803ffe50d6becc2aec3e5e268d3d7d8cd1415472cee09bc5d61400a -->
