...
- [227 xAI Responses WebSocket Web-Search Evidence](./227-xai-responses-websocket-web-search-evidence.md) — reserved for g04.080 card 222; exact model/profile, WebSocket request, provider-side bound, response, citation, usage, billing, and lifecycle truth
