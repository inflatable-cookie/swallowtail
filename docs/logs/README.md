...
- [2026-09-07 OpenCode HTTP 1.18.29 Claim](./2026-09-07-opencode-http-1-18-29-claim.md) — qualified `opencode.server` through official `1.18.29`; preserved baseline, gaps, `surface-19`, and `AllowUnverified`; g05.037 card 135
- [2026-09-07 OpenCode HTTP 1.18.29 Identity](./2026-09-07-opencode-http-1-18-29-identity.md) — Research 292 froze official npm/GitHub `1.18.29` as a compatible `surface-19` extension; production claims unchanged; g05.037 card 134
