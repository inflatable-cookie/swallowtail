...
| Keep production route versions current one family at a time. | Claude Code `2.1.252` qualified through g05.014 cards 037-038; Research 266 | Contract 029 identity-before-claim; Research 265-266; current-main validation | `g05.014` cards 037-038 |
