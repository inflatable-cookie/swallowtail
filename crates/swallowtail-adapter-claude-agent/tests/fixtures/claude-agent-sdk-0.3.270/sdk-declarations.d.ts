 ...
 * @anthropic-ai/claude-agent-sdk 0.3.270 sdk.d.ts.
 */
 ...
 * @anthropic-ai/claude-agent-sdk 0.3.270 `package/sdk.d.ts` (tarball sha256
 * 36e86fc13a1ddc8c026dcf5e5bcf72f4107bcbceaff1a45e7f81c5d44d703575, npm
 * shasum 2a1d5fd4e265320a64e62607ae87567bd7b955d8).
 *
 * These are the exact shapes the Card 116 registered-tool gap capsule cites
 * for REG-03, CB-01, MCP-02, and MCP-03, re-pinned here so the newer
 * wrapper point carries the same reproducible field lists. The CanUseTool
 * region gains only the two optional ask-dialog hints defaultToNo and
 * suppressAlwaysAllowRule; the callback signature and PermissionResult are
 * unchanged, and every MCP shape below is byte-identical to the 0.3.259
 * excerpt.
 *
 * Reproduce with:
 *   npm pack @anthropic-ai/claude-agent-sdk@0.3.270
 *   shasum -a 256 anthropic-ai-claude-agent-sdk-0.3.270.tgz
 *   tar xzf anthropic-ai-claude-agent-sdk-0.3.270.tgz
 *   sed -n '<start>,<end>p' package/sdk.d.ts
 *
 * Exact 0.3.270 line ranges, in the order the excerpts appear below:
 *   CanUseTool                       199-279
 *   PermissionResult                 2349-2361
 *   McpStdioServerConfig             1218-1233
 *   McpSSEServerConfig               1202-1217
 *   McpHttpServerConfig              1083-1098
 *   McpSdkServerConfig               1100-1107
 *   McpSdkServerConfigWithInstance   1109-1115
 *   McpServerConfig                  1118-1122
 *   McpServerStatus                  1124-1168
 *   McpServerStatusConfig            1170-1170
 *   Options.mcpServers               1799-1813
 *   Options.strictMcpConfig          2133-2145
 *   Query.mcpServerStatus            2770-2775
 *   SdkMcpToolDefinition             4903-4915
 *   tool                             8998-9002
 *   createSdkMcpServer               515-521
 *
 ...
 */
// CanUseTool — 0.3.270 package/sdk.d.ts:199-279
/**
...
// PermissionResult — 0.3.270 package/sdk.d.ts:2349-2361
...
// McpStdioServerConfig — 0.3.270 package/sdk.d.ts:1218-1233
...
// McpSSEServerConfig — 0.3.270 package/sdk.d.ts:1202-1217
...
// McpHttpServerConfig — 0.3.270 package/sdk.d.ts:1083-1098
...
// McpSdkServerConfig — 0.3.270 package/sdk.d.ts:1100-1107
...
// McpSdkServerConfigWithInstance — 0.3.270 package/sdk.d.ts:1109-1115
/**
...
// McpServerConfig — 0.3.270 package/sdk.d.ts:1118-1122
...
// McpServerStatus — 0.3.270 package/sdk.d.ts:1124-1168
/**
...
// McpServerStatusConfig — 0.3.270 package/sdk.d.ts:1170-1170
export declare type McpServerStatusConfig = McpServerConfigForProcessTransport | McpClaudeAIProxyServerConfig;
// Options.mcpServers — 0.3.270 package/sdk.d.ts:1799-1813
    /**
...
// Options.strictMcpConfig — 0.3.270 package/sdk.d.ts:2133-2145
    /**
...
// Query.mcpServerStatus — 0.3.270 package/sdk.d.ts:2770-2775
    /**
...
// SdkMcpToolDefinition — 0.3.270 package/sdk.d.ts:4903-4915
/**
...
// tool — 0.3.270 package/sdk.d.ts:8998-9002
...
// createSdkMcpServer — 0.3.270 package/sdk.d.ts:515-521
