retained_execution_classifications = {
    ...
    ("retained_background_execution", "cline.headless"): "operation_shape_not_applicable",
    ("retained_background_execution", "mistral-vibe.headless"): "operation_shape_not_applicable",
    ("retained_background_execution", "qoder.headless"): "operation_shape_not_applicable",
    ("stream_reattachment", "cline.headless"): "operation_shape_not_applicable",
    ("stream_reattachment", "mistral-vibe.headless"): "operation_shape_not_applicable",
    ("stream_reattachment", "qoder.headless"): "operation_shape_not_applicable",
    ("provider_managed_recovery", "cline.headless"): "selected_surface_absence",
    ("provider_managed_recovery", "mistral-vibe.headless"): "selected_surface_absence",
    ("provider_managed_recovery", "qoder.headless"): "selected_surface_absence",
    ("retained_background_execution", "copilot-cli.acp"): "operation_shape_not_applicable",
    ("retained_background_execution", "opencode.acp"): "operation_shape_not_applicable",
    ("stream_reattachment", "copilot-cli.acp"): "operation_shape_not_applicable",
    ("stream_reattachment", "opencode.acp"): "operation_shape_not_applicable",
    ("provider_managed_recovery", "copilot-cli.acp"): "upstream_unsupported",
    ("provider_managed_recovery", "opencode.acp"): "upstream_unsupported",
    ("retained_background_execution", "goose.acp"): "operation_shape_not_applicable",
    ("retained_background_execution", "kiro.acp"): "operation_shape_not_applicable",
    ("retained_background_execution", "deepagents.acp"): "operation_shape_not_applicable",
    ("stream_reattachment", "goose.acp"): "operation_shape_not_applicable",
    ("stream_reattachment", "kiro.acp"): "operation_shape_not_applicable",
    ("stream_reattachment", "deepagents.acp"): "operation_shape_not_applicable",
    ("provider_managed_recovery", "goose.acp"): "upstream_unsupported",
    ("provider_managed_recovery", "kiro.acp"): "upstream_unsupported",
    ("provider_managed_recovery", "deepagents.acp"): "upstream_unsupported",
}

working_resource_write_classifications = {
    ("bounded_workspace_text_write", "muse-code.headless"): "selected_surface_absence",
    ("bounded_workspace_text_write", "cline.acp"): "selected_surface_absence",
    ("bounded_workspace_text_write", "cline.headless"): "selected_surface_absence",
    ("bounded_workspace_text_write", "mistral-vibe.headless"): "selected_surface_absence",
    ("bounded_workspace_text_write", "qoder.headless"): "selected_surface_absence",
    ("bounded_workspace_text_write", "copilot-cli.acp"): "selected_surface_absence",
    ("bounded_workspace_text_write", "opencode.acp"): "selected_surface_absence",
    ("bounded_workspace_text_write", "goose.acp"): "selected_surface_absence",
    ("bounded_workspace_text_write", "kiro.acp"): "selected_surface_absence",
    ("bounded_workspace_text_write", "deepagents.acp"): "selected_surface_absence",
...
residual_exact_release_only = {
    ...
    ("unverified_newer_allowed", "cline.acp"),
    ("unverified_newer_allowed", "cline.headless"),
...
residual_selected_surface_absence = {
    ...
    ("interactive_session", "cline.headless"),
    ("interactive_session", "mistral-vibe.headless"),
    ("interactive_session", "qoder.headless"),
}
