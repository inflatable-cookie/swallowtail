...
- `swallowtail-adapter-opencode` implements version-bound OpenCode
  `1.14.48..=1.18.29` model discovery and ambient-host interactive sessions with
...
Tagged OpenAPI and artifact-tree evidence for 70 stable releases from `1.14.48`
through `1.18.29` closes six selected operations through every transitive local schema
...
release. Stable exact releases above `1.18.29` may execute as unverified through
