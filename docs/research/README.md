...
- [276 Antigravity 1.1.24 Identity](./276-antigravity-1-1-24-identity.md) — promoted through g05.021 card 050; official GitHub `1.1.24` is a compatible extension of the `1.1.17` ceiling; every hop ships one `antigravity` binary; downloaded binaries hashed and never executed; production claims unchanged
