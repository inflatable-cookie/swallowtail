...
fn unverified_newer_delete_requires_explicit_acceptance_and_close_is_not_promoted() {
    ...
    let preparation_host = FixtureHost::new(Scenario::Version, "0.74.0");
    ...
    let session_host = FixtureHost::new(Scenario::Success, "0.74.0");
    ...
    let delete_host = FixtureHost::new(Scenario::Success, "0.74.0");
