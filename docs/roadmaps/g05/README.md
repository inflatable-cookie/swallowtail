...
| Keep production route versions current one family at a time. | active campaign; eleven families processed through Research 319; Goose stopped at the selected-route provider-auth failure change and keeps exact `1.46.0` pending an operator ruling; Kiro manifest `2.21.4` is ready as the twelfth family; Command Code's separate live requalification remains named in g05.069; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308-319; Tom's 2026-09-14 direction | g05.072 |
...
- [g05.072 Kiro 2.21.4 Useful Newer](./072-kiro-2-21-4-useful-newer.md) — ready; exact official artifacts and the complete reproducible successor ledger decide whether the `QualifiedOnly` point advances from `2.18.1`
...
- [072 Kiro 2.21.4 Useful Newer](./072-kiro-2-21-4-useful-newer.md) — ready; twelfth Research 308 family; exact official artifacts and mapped executable evidence decide the one exact-pin outcome without executing Kiro
