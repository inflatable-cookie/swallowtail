...
- [2026-09-04 g05.028 Card 078 OpenCode HTTP Claim](./2026-09-04-g05-028-card-078-opencode-http-claim.md) — qualified `opencode.server` through official `1.18.28`; preserved baseline, gaps, `surface-19`, and `AllowUnverified`; awaiting exact-head review
