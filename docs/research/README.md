...
- [194 Gemini Live Output-Token-Maximum Evidence](./194-gemini-live-output-token-maximum-evidence.md) — promoted through g04.047 card 130; exact `gemini-3.1-flash-live-preview` admits dispatch of `1..=65536` on the thinking-plus-output-maximum facade point
