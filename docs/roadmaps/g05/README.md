...
| Prove one skill-discovery route and one watcher-enforcement route without flattening provider behavior. | Qoder empty; Claude admitted; portable core closed; host registry complete; Docker Engine containment evidence ready | Contracts 058-059; Research 256-260 | `g05.002` and `g05.003` |
...
- [g05.003 Operation-Scoped Watcher Proof](003-operation-scoped-watcher-proof.md) — ready; card 014 owns Docker Engine containment evidence
...
g05 has four numbered roadmaps: two completed milestones, one promoted
containment decision, and two ready proof milestones.
...
containment lease. The operator selected macOS via an opt-in OCI supervisor as
the first target. Card 014 is ready to test the exact current Docker Engine API
composition and produce Research 260. Card 010 stays gated until containment is
both proved and implemented; card 011 remains planned.
...
- [003 Operation-Scoped Watcher Proof](./003-operation-scoped-watcher-proof.md) — ready; card 014 ready; cards 010-011 gated behind containment proof and implementation
