...
`2.1.259` identity and rebinds the two exact axes. PR 188 was later withdrawn; this frozen
identity was rechecked on `2026-09-03` before the card 055 restoration —
`latest` and `next` are still exactly `0.3.259` — so it carries forward as
current evidence rather than as a historical point.
