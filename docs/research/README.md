...
- [272 Claude Agent ACP 0.73.0 Identity](./272-claude-agent-acp-0-73-0-identity.md) — promoted through g05.018 card 044; operator restart after unmerged `0.72.0`; official npm `0.73.0` is a compatible extension of `0.53.0..=0.70.0` initialize-meta-extensions-v7; host `0.63.0`; production claims unchanged; Claude Code and watcher untouched
