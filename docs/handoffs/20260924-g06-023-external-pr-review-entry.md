---
title: g06.023 — Review external Ollama Runtime 0.34.2
...
roadmap: docs/roadmaps/g06/023-ollama-runtime-0-34-2-review-entry.md
...
Take over external PR #354 for g06.023 through Queue review entry. The first
...
pilot. It raises `ollama.runtime` from `0.33.2` to `0.34.2`.

## Current State

Repository: `/Users/tom/Dev/projects/swallowtail`; integration branch: `main`.
Task: `docs/roadmaps/g06/023-ollama-runtime-0-34-2-review-entry.md`.
PR: https://github.com/inflatable-cookie/swallowtail/pull/354.
Existing branch: `cursor/ollama-0-34-2-currentness-c935`.
External head inspected before planning: `eb7969e90d6efadb457829f21b0d075700db3296`.
Paseo workspace: `wks_db7a0071ff410142` (created for this intake).
Workspace directory: `/Users/tom/.paseo/worktrees/2ee7rnl8/swallowtail-pr354-review-entry`.
...
reserved **Research 342**. Planning integration merged `main` into the branch
...
029 and the task card, then require the Research 342 renumber. Report through
the authenticated Queue review run.

## Completion Protocol

Retain the same branch and PR. Exact-head independent review is mandatory.
Required evidence: `effigy validate:focused swallowtail-adapter-ollama`,
`effigy package:verify-affected swallowtail-adapter-ollama`, `effigy qa:docs`,
