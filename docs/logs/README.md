...
- [2026-09-21 Codex 0.155.1 Identity](./2026-09-21-codex-0-155-1-identity.md) — Research 331 froze both published hops from qualified `0.154.0` to official `0.155.1` with complete wrapper/platform/source-tree inventories; exec tree byte-identical; selected schema params byte-identical or additive-only with bounded unmapped deltas; compatible extension named; production claims unchanged
