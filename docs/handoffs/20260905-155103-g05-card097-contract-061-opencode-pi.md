...
# Card 097 — Contract 061 OpenCode and Pi package completion
...
- Card: `docs/roadmaps/g05/batch-cards/097-contract-061-opencode-pi-package-completion.md`
- Manifest: `docs/roadmaps/g05/009-contract-061-consumer-projection-realization.md`, section `Cards 097-099 Manifest`
- Worker branch: `worker/g05-card097-opencode-pi`
- Dedicated workspace: `g05-card097-opencode-pi`
...
- `crates/swallowtail-adapter-opencode/**`
- `crates/swallowtail-adapter-pi/**`
