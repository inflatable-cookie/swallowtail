...
use headless_support::{FIXTURE_CWD, FixtureHost, stderr_chunk};
use swallowtail_adapter_mistral_vibe::{
    ...
    MistralVibeHeadlessPreparationProbe, MistralVibeHeadlessRunProfileInput, MistralVibeMaxTurns,
...
use swallowtail_runtime::{
    ...
    ProcessExit, RequestId, ScopeId, TerminalStatus, WorkingResourceRef,
};
...
const LIMIT_STDERR: &str = include_str!("fixtures/mistral-vibe-headless-2.24.2/limit-stderr.txt");
...
include!("prepared_facade/max_turns.rs");
