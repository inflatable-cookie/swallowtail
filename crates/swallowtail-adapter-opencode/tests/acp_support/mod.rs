...
use swallowtail_adapter_opencode::{
    opencode_acp_binding, opencode_acp_descriptor, opencode_acp_host_account_access_profile,
};
...
impl FixtureHost {
    pub fn new(scenario: Scenario) -> Self {
        Self::with_version(scenario, "1.18.32")
    }
...
fn fixture_failure() -> RuntimeFailure {
    RuntimeFailure::new(swallowtail_core::SafeDiagnostic::new(
        "fixture.opencode_acp.failed",
        "OpenCode ACP fixture failed",
    ))
}
