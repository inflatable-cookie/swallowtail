...
- [x] card 238 promotes exact Claude Code headless autocompaction evidence or
      an empty set
- [x] card 239 promotes exact Codex app-server personality evidence or an empty
      set
- [x] card 240 promotes exact Gemini CLI headless sandbox evidence or an empty
      set
- [x] card 241 promotes exact Cline ACP Plan-mode evidence or an empty set
...
- [x] Research 237-240 each contain frozen sources, exact route boundaries,
