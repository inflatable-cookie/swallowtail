...
Status: complete; realized by card 034 (PR 222, merged `404fa068`) on the card 073 and 079 baselines; retained as historical gate evidence like the Batch 9.1, Claude Agent, and Cline gates
Owner: Tom
Date: 2026-09-01
...
withheld and candidate F unpromoted for now, with the candidate C audit as
the reopen trigger. Card 064 later found no catalogue route needs the
vocabulary, so that trigger did not fire. Card 066 then stopped candidate I
on the identical gap: `deepseek-harness.local-server`
...
- [completed card 033](../roadmaps/archive/g05.md)
- [planned card 034](../roadmaps/archive/g05.md)
