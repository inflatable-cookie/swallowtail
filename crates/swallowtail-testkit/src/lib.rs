...
pub use grok_acp_client_mcp_probe::{
    ...
    ECHO_MCP_TRANSCRIPT_ENV, EchoMcpTranscript, GrokAcpClientMcpCapsule, GrokAcpClientMcpCleanup,
    GrokAcpClientMcpError, GrokAcpClientMcpErrorKind, GrokAcpClientMcpFrame, GrokAcpClientMcpPeer,
    LiveGrokAcpPeer, append_echo_mcp_transcript, desktop_grok_acp_client_mcp_probe_is_gated_open,
