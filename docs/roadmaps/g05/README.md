...
| Keep production route versions current one family at a time. | active campaign; Claude Agent ACP, Qwen Code, Codex, Cursor Agent, Ollama, and Grok Build ACP completed through `0.76.0`, `0.23.3`, `0.154.0`, `2026.09.10-fd3934a`, `0.33.2` with a named `0.33.3` decoder stop, and `1.0.30`; the Claude Agent SDK `0.3.270` / native `2.1.270` exact tuple is ready as the seventh family; Gemini deferral lifted; Kimi, Antigravity, and Oh My Pi reopened under existing containment and identity rules | Contract 029; Research 308-314; Tom's 2026-09-14 direction | g05.065 |
...
- [g05.065 Claude Agent SDK 0.3.270 Tuple Useful Newer](./065-claude-agent-sdk-0-3-270-tuple-useful-newer.md) — ready; provider-free exact tuple rebind with live-evidence reconciliation
...
- [065 Claude Agent SDK 0.3.270 Tuple Useful Newer](./065-claude-agent-sdk-0-3-270-tuple-useful-newer.md) — ready; exact SDK/native rebind only if complete provider-free evidence admits; old live tuple evidence stays exact
