...
`0.22.0`, `0.30.0`, `0.32.1`, `0.32.14`, and `0.32.15`; froze current official
thinking and chat API documentation specimens; and audited the prepared route's
...
`"max"` entered the tagged `ThinkValue` parser at `v0.22.0`. Earlier
qualification points reject it during JSON unmarshaling with an invalid think
value error. From `v0.22.0` through `0.32.15`, the wire parser accepts
