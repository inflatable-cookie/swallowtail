...
const EXECUTION: &str = include_str!("fixtures/opencode-v1.14.48-v1.18.4/compatibility.json");
const CONTINUITY: &str = include_str!("fixtures/opencode-v1.14.48-v1.18.4/session-continuity.json");
