...
- [g05.003 Operation-Scoped Watcher Proof](003-operation-scoped-watcher-proof.md) — ready; card 010 is ready for exact `2.1.251` credential-free binding; card 011 keeps the separate live gate
...
`2.1.251`. The post-merge reassessment admits card 010 for credential-free
binding at exact `2.1.251`; it does not admit a watcher range or support claim.
...
- [003 Operation-Scoped Watcher Proof](./003-operation-scoped-watcher-proof.md) — ready; card 010 ready for exact `2.1.251` binding; card 011 waits on binding and live authorization
