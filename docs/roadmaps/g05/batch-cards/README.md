...
- [030-contract-061-acknowledgement-candidate-reassessment.md](./030-contract-061-acknowledgement-candidate-reassessment.md) — evidence stop; D, F, and G all fail rubric item 2 on current `main`; no candidate promoted; acknowledgement public-baseline gate needed
