...
| Settle vocabulary, provenance, privacy, process ownership, watcher lifecycle, and turn-completion policy. | active | Research 255; current architecture; Contracts 013, 017, 041, 044 | `g05.001` card 002 |
...
- [g05.001 Harness Skill And Watcher Surface Inventory](001-harness-skill-and-watcher-surface-inventory.md) — ready; Research 255 promoted; card 001 closed, card 002 ready, card 003 gated by operator decisions
...
Card 001 is complete. Card 002 is ready to classify Research 255 and return the
four operator choices already preserved in triage. It does not inject a skill,
start or stop a process, run a provider prompt, inspect user homes, mutate
harness configuration, add a route, define public API, or promote architecture
or contracts. Card 003 remains planned behind recorded operator decisions.
...
- [001 Harness Skill And Watcher Surface Inventory](./001-harness-skill-and-watcher-surface-inventory.md) — ready; Research 255 promoted; card 001 closed, card 002 ready, card 003 gated by operator decisions
