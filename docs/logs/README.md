...
- [2026-09-04 g05.021 Card 051 v0.4.0 Candidate Closeout](./2026-09-04-g05-021-card-051-v0-4-0-candidate-closeout.md) — PR 201 exact head `10d9b7a0` accepted and merged as immutable candidate `56f3913a`; canonical workflow-dispatch run 33853812785 passed all six jobs at that exact SHA; card 051 complete; card 052 planned and blocked on operator application-smoke authority
