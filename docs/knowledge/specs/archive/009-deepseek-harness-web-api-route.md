...
- `docs/knowledge/architecture/system-architecture.md` and
  `docs/knowledge/architecture/release-and-package-topology.md` on package acceptance
...
- task g03.070 (removed at the lean Northstar cut; see Git history before `49b0d308`)
