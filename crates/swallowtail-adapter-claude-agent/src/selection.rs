...
pub const CLAUDE_AGENT_ACP_LATEST_QUALIFIED_VERSION: &str = "0.76.0";
...
mod tests {
    ...
    fn claim_preserves_seven_milestones_exclusions_and_visible_newer_execution() {
        ...
        assert_eq!(claim.latest_qualified().as_str(), "0.76.0");
