...
g05 has four numbered roadmaps: two completed milestones and two ready proof
milestones.
...
boundary. Card 009 completed the registry on restacked PR 117. Card 014 restored
ordinary host-approved process supervision and an explicit detached-process
non-claim. Card 010 follows that repair after merge; card 011 remains planned.
