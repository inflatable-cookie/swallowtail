...
provider-operation observation gate on 2026-09-04 (card 070); the gate is
promoted into Contract 061 and ready card 073 owns the runtime baseline;
candidate I's completion card compiles after card 073 merges; census-source corrections
