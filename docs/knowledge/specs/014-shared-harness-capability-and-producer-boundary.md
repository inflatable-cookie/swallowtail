...
That decision stands. The Longhorn counterpart was
[PR 22](https://github.com/inflatable-cookie/longhorn/pull/22), aligned and
independently passed at `6ce4aa1beafad6748af238d19fb47ffaa1ad342f` in
[review comment 5563025824](https://github.com/inflatable-cookie/longhorn/pull/22#issuecomment-5563025824),
whose Contract 023 and Spec 002 then adopted Desktop's table. **That counterpart
is now withdrawn for the production MCP role** by Longhorn
[`7ea44d23`](https://github.com/inflatable-cookie/longhorn/commit/7ea44d23)
(operator
direction 2026-09-22, shipping in Longhorn `0.2.0`): the production MCP is
...
- `docs/knowledge/architecture/repository-authority-map.md`
- new contracts and amendments named above
- Contract 061 projection vocabulary and adapter rows
- task g06.001 (removed at the lean Northstar cut; see Git history before `49b0d308`)
