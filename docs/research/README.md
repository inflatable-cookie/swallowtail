...
- [213 Codex Exec Model-Verbosity Evidence](./213-codex-exec-model-verbosity-evidence.md) — promoted through g04.066 card 184; exact `0.147.0..=0.149.1` openai Responses exec admits seven frozen slugs × `low|medium|high`; live-catalog acceptance withheld
