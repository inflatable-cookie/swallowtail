...
- `docs/knowledge/contracts/053-opt-in-debug-observation.md`
- `docs/knowledge/contracts/010-execution-host-services-and-inputs.md`
- `docs/knowledge/architecture/system-architecture.md`
- task g03.055 (removed at the lean Northstar cut; see Git history before `49b0d308`)
